		...
		<? if($rvCekDataHeaderEQx->REQUEST_BY == $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=strfb&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST">
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_TIPEBARANG_KODE.ticket_needassist = 'NO' AND
																						...
																						AND ((ITH_TIPEBARANG_KODE.TICKETTRANSFERTO_OUTLETCODE ='".$_GET['uid']."' OR
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? }elseif($rCekDataInputan->received_date!=''){ ?>	
																	&nbsp;&nbsp;<b>Item&nbsp;Status&nbsp;:</b>&nbsp;&nbsp;<?='Transferred By Store '.ucwords(strtolower($rCekDataInputan->tickettransferto_outletname))?><br>
