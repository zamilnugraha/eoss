		...
		?>	
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=srvfb&pid=<?=$_GET['pid']?>" method="POST">
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? 
																	$qCekDataInputan = mysql_query("SELECT DISTINCT received_by, received_date, tickettransferto_outletcode, tickettransferto_outletname 
																									FROM ITH_TIPEBARANG_KODE 
																									WHERE ticket_id ='".$_GET['pid']."' 
																									AND tickettransferto_outletcode = '".$_GET['uid']."'
