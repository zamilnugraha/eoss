...
<? if(($userlevel == 3)){ /* SEND MAIL TO REGIONAL OPR MANAGER FROM STORE REQUEST */?>	
		...
		<div id="content" style="height:560px;margin-top:100px;">
			...
			<div class="body" style="height:500px;">				
				...
				<? 
					...
					$usrnikatasan = $_SESSION['nik_atasan'];
														...
														while($rCekDataYangDiApprovedTest = mysql_fetch_object($qCekDataYangDiApprovedTest))
														{
															...
															$qtyItemXY = $rCekDataYangDiApprovedTest->kuantitas.' Unit<br>';			
																$bodymail2 .= "																		
				...
				?>
					...
					<font color="#fff" style="font-weight:bold;text-align:center;">SORRY,MESSAGE NOT SEND (NOT SEND TO ROM)!!!</font><br>
					<b>PLEASE RESEND YOUR REQUEST, UNTIL SUCCESFULLY SUBMITED !!!</b><br>					
					<br>
					<button onclick="location.href = '?view=sendmailtorom&status=resendprocess&pid=<?=$_GET['pid'];?>&uid=<?=$_SESSION['user_nik'];?>';" id="myButton" class="submit-btn">RESEND</button>&nbsp;
				</div>				
				<div><br></div>
				<div><br></div>	
				<? 
				...
				##	header ("Location: index.php?view=storemessage");
					header ("Location: index.php?view=sendmailtorom&status=resendsuccess&pid=$newid");
		...
		<?php
														...
														while($rCekDataYangDiApproved = mysql_fetch_object($qCekDataYangDiApproved))
														{
															...
															$qtyItemXY = $rCekDataYangDiApproved->kuantitas.' Unit<br>';	
																...
																$mail->Subject    = "[E-OPERATION SUPPORT PROGRAM].APPROVAL-FOR-ROM_REQITEM : $subjectTicketStoreReq2";
																$mail->AltBody    = "$subjectTicketStoreReq2"; 
				...
				{
		?>	
					<?="X2<br>".$mail->ErrorInfo; #exit;?><br><br>
					<b>SORRY,MESSAGE NOT SEND !!!</b><br>
					<b>PLEASE RESEND YOUR REQUEST, UNTIL SUCCESFULLY SUBMITED !!!</b><br>					
					<br>
					<button onclick="location.href = '?view=sendmailtorom&status=resendprocess&pid=<?=$_GET['pid'];?>&uid=<?=$_SESSION['user_nik'];?>';" id="myButton" class="submit-btn">RESEND</button>&nbsp;
		...
		<?php
														...
														while($rCekDataYangDiApproved = mysql_fetch_object($qCekDataYangDiApproved))
														{
															...
															$qtyItemXY = $rCekDataYangDiApproved->kuantitas.' Unit<br>';	
																...
																$mail->Subject    = "[E-OPERATION SUPPORT PROGRAM].APPROVAL-FOR-ROM-REQITEMX : $subjectTicketStoreReq2";
																$mail->AltBody    = "$subjectTicketStoreReq2"; 
				...
				{
		?>	
					<b>SORRY,MESSAGE NOT SEND (NOT SEND TO ROM)!!!</b><br>
					<b>PLEASE RESEND YOUR REQUEST, UNTIL SUCCESFULLY SUBMITED !!!</b><br>					
					<br>
					<button onclick="location.href = '?view=sendmailtorom&status=resendprocess&pid=<?=$_GET['pid'];?>&uid=<?=$_SESSION['user_nik'];?>';" id="myButton" class="submit-btn">RESEND</button>&nbsp;
				<? }else{ ?>	
