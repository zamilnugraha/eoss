...
<tbody>
	...
	<?php 
		...
		$mydeptkd = $rcekdept->kode_departemen;
			...
			if($_POST['statusticket_sc']=='6')
			{
				if($_POST['supportby_sc']=='6'){
					...
					LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
					 ...
					 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik								 
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4') 
					AND 		
					((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
					(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1'					
					AND 		
					((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
					(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					...
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' 					AND 		
					((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
					(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					...
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND 
					ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') 					AND 		
					((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
					(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}	
			}elseif($_POST['statusticket_sc']=='1')
			{
				if($_POST['supportby_sc']=='6'){
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4') 
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '1' AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='2'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
					FROM ITH_TICKET_HEADER 
					...
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '1' AND 
					ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}	
			}elseif($_POST['statusticket_sc']=='2')
			{
				if($_POST['supportby_sc']=='6'){
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4') 
						AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='1'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '2' AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='2'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
				...
				}elseif($_POST['supportby_sc']=='3')
				{
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '3' AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='3'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
				...
				}elseif($_POST['supportby_sc']=='0')
				{
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '0' AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='3'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
				...
				}elseif($_POST['supportby_sc']=='5')
				{
					...
					WHERE 
					ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_USER.user_realname!='Administrator' AND
					ITH_TICKET_HEADER.ticketstatus_id = '5' AND 
					ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['supportby_sc']=='3'){
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name 
		...
		($_SESSION['user_level'] == 1001)){
			$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
				LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
				 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
				 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
				WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
				ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') 
				AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
				ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));	
			if($_SESSION['udeptid']=='GENERAL MANAGER')
			{	
				if($_POST['statusticket_sc']=='6')
				{
					if($_POST['supportby_sc']=='6')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						(ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						(ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						(ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						(ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND 
						ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						(ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='1')
				{
					...
					{		
						...
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '1' 
						AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '1' 
						AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '1' 
						AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '1' 
						AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '1' 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='2')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '2' 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
				...
				}elseif($_POST['statusticket_sc']=='3')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id = '3' 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
				...
				}elseif($_POST['statusticket_sc']=='0')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND  ITH_TICKET_HEADER.ticketstatus_id = '0' 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
				...
				}elseif($_POST['statusticket_sc']=='5')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND  ITH_TICKET_HEADER.ticketstatus_id = '5' 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
				...
				}elseif($_POST['statusticket_sc']=='1')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '1' AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='2')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='3')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '3' AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='0')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				}elseif($_POST['statusticket_sc']=='5')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='2')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid = '3' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='4')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='7')
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '5' AND ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}	
				...
				if($_POST['statusticket_sc']=='6')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))		 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
				...
				}elseif($_POST['statusticket_sc']=='0')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 ...
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND
						ITH_TICKET_HEADER.ticketstatus_id = '0' AND ITH_TICKET_HEADER.ticket_udeptid = '2' AND 
						((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
						(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%'))			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='3')
				...
				if($_POST['statusticket_sc']=='6')
				{
					...
					{		
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' ANDITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') 
						AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')			 
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					}elseif($_POST['supportby_sc']=='1')
					{		
		...
		}elseif(($_SESSION['user_level'] == 100)||($_SESSION['user_level'] == 21)){
			$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
			LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
			LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
			LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
			...
			ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				...
				{	
					...
					LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
					 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
					 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
					WHERE ITH_TICKET_HEADER.ticketstatus_id = '0'
					AND ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				}elseif($_POST['statusticket_sc']=='5')
				{	
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
		...
		}elseif(($_SESSION['user_level'] == 101)||($_SESSION['user_level'] == 22)){
			$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
			LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
			 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
			 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
		...
		}elseif(($_SESSION['user_level'] == 102)||($_SESSION['user_level'] == 23)){
			$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
			LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
			 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
			 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
			WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' AND ITH_TICKET_HEADER.ticket_udeptid = '4' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')	
			ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
				if($_POST['statusticket_sc']=='6')
				{	
					$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
		...
		or isset($_POST['statusticket_sc']) or isset($_POST['supportby_sc']) AND isset($_POST['halaman'])) 
		{
				...
				if(($_SESSION['user_level'] == 1)){				
						$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
								...
								AND ((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR (ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%')) 
					...
					if($_SESSION['udeptid']=='GENERAL MANAGER')
					{
						...
						}elseif($_POST['statusticket_sc']=='5')
						{
							$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
									...
									WHERE ITH_TICKET_HEADER.ticket_createby='$_SESSION[user_nik]' 
									AND ((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR (ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%')) 
									AND ITH_TICKET_HEADER.ticketstatus_id = '5'	AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
						}		
					}elseif($_SESSION['udeptid']=='IT')
	...
	<tr style="display:show;">
		...
		Reference Ticket = 
		<a href="<?='http://'.$_SERVER['SERVER_NAME'].'/index.php?view=comment&pid='.$dtmyticket->ticketreference_id.'&uid='.$_SESSION['user_nik']?>" title="Reference Ticket" target="_parent">
		...
		<img src="img/Readmore1.png" alt="" height="50" width="50"></img>
					...
					<? if($_SESSION['user_level']!= 1){?>					
						<? 	if($dtmyticket->ticket_viaby!='Via Web'){ ?>		
								<? if(($dtmyticket->ticketstatus_id == '2')){ ?>
			...
			<tbody>
					...
					($_SESSION['user_level'] == 1000)||($_SESSION['user_level'] == 1001)){
						...
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
						WHERE ITH_TICKET_HEADER.ticket_udeptid = 'IT' AND ITH_TICKET_HEADER.ticketstatus_id = '1'
						ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
					#	echo "<br>(#)jumlah data";
					/*
								...
								*//**
								if(isset($_POST['cari'])&&(isset($_POST['halaman']))) {
									...
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
											LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
											WHERE ITH_TICKET_HEADER.ticket_udeptid = 'IT' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT ".(($halaman - 1) * $jml_per_halaman).", $jml_per_halaman");
				...
				<tr>
					...
					Reference Ticket = 
					<a href="<?='http://'.$_SERVER['SERVER_NAME'].'/index.php?view=comment&pid='.$dtmyticketx->ticketreference_id.'&uid='.$_SESSION['user_nik']?>" title="Reference Ticket" target="_parent">
					...
					<td><a href="<?='http://'.$_SERVER['SERVER_NAME'].'/index.php?view=comment&pid='.$dtmyticketx->ticket_id.'&uid='.$_SESSION['user_nik']?>" title="Ticket ID: <?=$dtmyticketx->ticket_id?>" target="_parent">Readmore</a></td>	
					<? if($_SESSION['user_level']!= 1){?>					
