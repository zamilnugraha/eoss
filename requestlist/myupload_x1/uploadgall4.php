...
$gallery_name4 = $_FILES["myfile"]["name"];
$gallery_size4 = $_FILES["myfile"]["size"];
$gallery_location4 = '/dc9144e0ece8bcd25dd3a4dcb7b305a3/picture/gallery/data_'.$id_talentdetail.'/';
...
if(isset($_FILES["myfile"])){
    ...
    if(move_uploaded_file($_FILES["myfile"]["tmp_name"],$output_dir. $gallery_name4))
	{		
		mysql_query("UPDATE talent_detail SET gallery_name4='$gallery_name4', gallery_location4='$gallery_location4', gallery_size4='$gallery_size4' WHERE id_talentdetail='$id_talentdetail' ");
    }else{
		echo "Gagal Uplaod";
	}
