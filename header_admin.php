    ...
    <nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
        ...
        <div class="menu-logo">
            <div class="navbar-brand">
                ...
                <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-5" href="index.php?m=home&to=welcomepage&pid=&username=<?=$_SESSION['user_nik']?>">E-OPERATION SUPPORT SYSTEM</a></span>
            </div>
        </div>
		...
		<? if($_GET['to']=='fsd'){ ?>
			...
			||($_GET['mdl']=='movement')||($_GET['mdl']=='equipmentmovement'))
			{ ?>
