(function($) {
	...
	$(document).ready(function(e) {
		...
		$("#simpan-rinventorydetail").bind("click", function(event) {
			...
			$.post(url, {title: v_title, user_name: v_user_name, user_nik: v_user_nik, user_telpon: v_user_telpon, items_id: v_items_id, date_request: v_date_request, start: v_start, end: v_end, kebutuhan_descr: v_kebutuhan_descr, approval_name: v_approval_name, id: id_reqinventory} ,function() {
				$("#data-rinventorydetail").load(main);
