...
<form id="formfilter">				
				...
				<table class="table table-hover" cellpadding="0" cellspacing="0" style="border:0;">				
						<tr>
									...
									<td>
										<a href='<?="http://".$_SERVER['SERVER_NAME']."/index.php?view=new_romuser"?>' title='New ROM User' target='_parent'><img src='img/adduser.jpg' alt='' height='20' width='40'></img></a>
									</td>									
						</tr>
				...
				<div class="input-prepend pull-right" style="margin-top:-50px;">
						...
						<input class="span2" id="prependedInput" style="width:250px;" type="text" name="pencarian" placeholder="Search By User Name, User NIK">
				</div>
		
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					<font size="4">&nbsp;List ROM User</font>
				...
				<center>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th style="background-color:#909090;color:#fff;border-color:white;width:5px;text-align:center;">User NIK</th>
											<th style="background-color:#909090;color:#fff;border-color:white;width:80px;text-align:center;">ROM User<br>Name</th>
										...
										<!--<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">NIK<br>Atasan</th>0-->
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">GMO<br>Name</th>
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">DIREKSI<br>Name</th>
				...
				/*	{"data": "areaName"}, */				
					{"data": "",
					  ...
					  "mRender": function(data, type, full) {
						  var link = "";
						if(full.romCode==0001){
						  link = "Area I-1 s/d <br> Area I-7";
						}		
						if(full.romCode==0002){
						  link = "Area II-1 s/d <br> Area II-7";
						}		
						if(full.romCode=="0003a"){
						  link = "Area III-1 s/d <br> Area III-7";
						}		
						if(full.romCode=="0003b"){
						  link = "Area III-8 s/d <br> Area III-12";
						}		
						if(full.romCode==0004){
						  link = "Area IV-1 <br> s/d <br> Area IV-7";
						}		
						if(full.romCode==0005){
						  link = "Area V-1 <br> s/d <br> Area V-7";
						}		
						if(full.romCode==0006){
						  link = "Area VI-1  <br> s/d <br> Area VI-7";
						}		
						if(full.romCode==0007){
						  link = "Area VII-1 <br> s/d <br> Area VII-7";
						}		
						if(full.romCode==0008){
						  link = "Area VIII-1 <br> s/d <br> Area VIII-7";
						}		
						if(full.romCode==0009){
						  link = "Area IX-1 <br> s/d <br> Area IX-7";
						}		
						 return link;
					  }},
