														...
														{	
																	...
																	**/
																	$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																								...
																								AND ITH_TIPEBARANG_KODE.TICKETAPPROVALSTATUSID_ROM != '0'
																	...
																	<tr>												
																		   ...
																		   ?>
																			...
																			<li><b> Book Value: <font color="orange"><!?='<strong>Rp.&nbsp;'.number_format($rvSCatReplace2->NILAIBUKUREPLACE, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>-->
																				<? if(($rvCekDataEQx["KETERANGAN"] =='ADD REQUEST')||($rvCekDataEQx["KETERANGAN"] =='REPLACEMENT REQUEST')){ ?>	
																						<li><b> New Price : <font color="brown"><?='<strong>Rp.&nbsp;'.number_format($rvSCatReplace2->ITEMCODEREPLACE, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>
																		...
																		<td width="22%">								
																			...
																			<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_GMO"]=='-'){ ?>																		
																				<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</font><font color="brown">&nbsp;&nbsp;Not In Needed.</b>';?></font><br>
																			...
																			<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_GMO"]=='0'){ ?>																		
																				<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</font><font color="red">&nbsp;&nbsp;Not Approved.</b>';?></font><br>
																			<? } ?>																
