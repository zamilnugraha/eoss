...
?>
	...
	{ ?>
		...
		<? }elseif(($detailmyticketKeteranganData->keterangan=='MOVE TO WAREHOUSE')){ ?>
			...
			<font color="#ffffff"><b><u>TRANSFER ITEM FROM STORES TO FSD TECHNICIANS<!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI --> </u></b></font>
			<? }elseif($detailmyticketKeteranganData->ticket_needassist=='NO'){ //ASSIGN TECHNICIAN FROM OPR MANAGER ?>
			<font color="#ffffff"><b><u>TRANSFER ITEM FROM STORES TO OPR TECHNICIANS </u></b></font>
			<? } ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
						...
						<input type="submit" value="SubmitQ" style="margin-left:1020px;" />	
						<? } ?>
					</form>	
					</div>
			...
			<style>
				...
				<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;"> 
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? if(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->transfer_date=='')){ ?>
																		...
																		?>
																			...
																			<p name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					&nbsp;&nbsp; &nbsp;<input type="text" name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" class="date start" style="margin-left:15px;width:60%;" value=""/>  							
																			</p>
																...
																<? }elseif(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->transfer_date!='')){ ?>
																		&nbsp;&nbsp;<b>Transferred&nbsp;By&nbsp; :</b>&nbsp;&nbsp;<?=strtoupper($rCekDataInputan->pictakein_by)?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;Date&nbsp;:</b>&nbsp;&nbsp;<?=$rCekDataInputan->transfer_date?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;To&nbsp;:</b>&nbsp;&nbsp;<?=strtoupper($transferbyNames)?>		
																	<? } ?>			
						...
						<? if($rCekDataInputan->received_date==''){ ?>	
						<input type="submit" value="SubmitR" style="margin-left:1020px;" />	
						<? } ?>
					</form>	
					</div>	
				</div>	
