					...
					<table class="blueTable" border="1"> 
						<thead>
							<tr>
								...
								?>														
									<!--<th width="18%" style="color:#ffffff;">Name Of<br>Goods Ordered</th>-->
									<th width="18%" style="color:#ffffff;">Item Request</th>
									<th width="7%" style="color:#ffffff;">Date Of<br>Request</th>	
									<? 
										$qCekKdTpBrg = mysql_query("SELECT kode_tipebrg,keterangan FROM ITH_TIPEBARANG_KODE 
																	WHERE ticket_id = '".$_GET['pid']."'");
										$rCekKdTpBrg = mysql_fetch_object($qCekKdTpBrg);
										if(($rCekKdTpBrg->keterangan =='MOVE TO OTHER STORE')||($rCekKdTpBrg->keterangan =='MOVE TO WAREHOUSE')){	
									?>		
									<th width="5%" style="color:#ffffff;">Transfer<br>To</th>						
										<? }elseif(($rCekKdTpBrg->keterangan =='ADDING REQUEST')||($rCekKdTpBrg->keterangan =='REPLACEMENT REQUEST')){ ?>
									<th width="5%" style="color:#ffffff;">Quantity<br>Requested</th>						
										<? } ?>
									<th width="20%" style="color:#ffffff;">Area Manager<br>Approval</th>							
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_USER.USER_REALNAME,ITH_TIPEBARANG_KODE.KETERANGAN,
																						...
																						ITH_TICKET_HEADER.TICKET_CREATEBY, ITH_TIPEBARANG_KODE.TICKET_NEEDASSIST, 
												...
												{	
													...
													{	 
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																<td width="18%">
																<div style="margin-left:20px;"><font color="brown"><b><?=$rvCekDataEQx["KODE_TIPEBARANG"].' - '.$rvCekDataEQx["NAMA_TIPEBARANG"];?></b></font>
																</div>
																	<? /* Cek Store From ? */
																...
																**/
																  ...
																  <ul>
																   <? 	$objConnectReplaceOldItem = oci_connect('fsd', 'fsd', 'localhost:1521/XE'); 
																	...
																	/*	echo "<br>
																		<br>SELECT DISTINCT 																			
																		<br>	 FSDMSTTRX_STORENEW.UMUR_BUKU AS UMURBUKUOLDITEM,
																		<br>	 FSDMSTTRX_STORENEW.NILAI_BUKU AS NILAIBUKUOLDITEM,
																		<br>	 FSDBRGEQASSET_NEW.NOMOR_TAGING AS NOTAGGING
																		<br>	 FROM FSDMSTTRX_STORENEW 
																		<br>	 JOIN FSDBRGEQASSET_NEW ON FSDMSTTRX_STORENEW.ITEM_CODE = FSDBRGEQASSET_NEW.ITEM_CODE																			 
																		<br>	 WHERE 
																		<br>	 ((FSDMSTTRX_STORENEW.OUTLET_CODE = '".$rvCekDataEQx['TICKET_CREATEBY']."')OR(FSDMSTTRX_STORENEW.OUTLET_CODE = '".$rCekStoreFromNameNewItem->user_nik."'))																			 
																		<br> 	 AND FSDMSTTRX_STORENEW.ITEM_CODE = '".$rvCekDataEQx["KODE_TIPEBARANG"]."' 
																		<br>	 AND FSDBRGEQASSET_NEW.ITEM_NAME LIKE '%OLD'";	*/				
																   ...
																   ?>
																			...
																			<!--<li><b> New Price : <font color="brown"><!?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->ITEMPRICEOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>-->
																				<? if(($rvCekDataEQx["KETERANGAN"] =='ADDING REQUEST')||($rvCekDataEQx["KETERANGAN"] =='REPLACEMENT REQUEST')){ ?>	
																					<li><b> New Price : <font color="brown"><?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->ITEMPRICEOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>
																				<? }else{ ?>
																					<li><b> Tagging Number : <font color="brown"><b><?=$rvSCatReplaceOldItem->NOTAGGING?></b></font>
																				<? } ?>																		
																		<? 
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<td width="6%">
																	...
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_AM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_AM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_AM"];?></font>
																</td>
																<td width="20%">																	
																	...
																	<? } ?>																		
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_ROM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_ROM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_ROM"];?></font>
																</td>
																<td width="20%">																	
																	...
																	<? } ?>																			
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_GMO"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_GMO"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time :</b> </font><font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_GMO"];?></font>
																</td>																
