...
$gallery_name8 = $_FILES["myfile"]["name"];
$gallery_size8 = $_FILES["myfile"]["size"];
$gallery_location8 = '/dc9144e0ece8bcd25dd3a4dcb7b305a3/picture/gallery/data_'.$id_talentdetail.'/';
...
if(isset($_FILES["myfile"])){
    ...
    if(move_uploaded_file($_FILES["myfile"]["tmp_name"],$output_dir. $gallery_name8))
	{		
		mysql_query("UPDATE talent_detail SET gallery_name8='$gallery_name8', gallery_location8='$gallery_location8', gallery_size8='$gallery_size8' WHERE id_talentdetail='$id_talentdetail' ");
    }else{
		echo "Gagal Uplaod";
	}
