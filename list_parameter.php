...
<? } ?>
    ...
    <div class="body" style="height:1250px;">
		...
		<div style="margin-top:-10px;">
			<!--<iframe src="storelist/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>-->
			<iframe src="parameterlist/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
		</div>
    </div>
</div>
