...
button.filter {
	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:15px;">
		<div class="row">
				...
				?>					
				<tr>
					<td><label style="width:40px;">DATE&nbsp;REQ:</label></td>
					<td><p id="dtfrom_sc" name="dtfrom_sc" style="font-size:10pt;">
							&nbsp;&nbsp; &nbsp;<input type="text" id="dtfrom_sc" name="dtfrom_sc" class="date start" style="margin-left:15px;width:80px;" value="<?=$mydate?>"/>  							
					</p></td>
					
					<td style="width:50px;margin-left:0px;"><label>To :</label></td>
							<td><p id="dtto_sc" name="dtto_sc" style="font-size:10pt;">
							&nbsp;&nbsp; &nbsp;<input type="text" id="dtto_sc" name="dtto_sc" class="date end" style="margin-left:-35px;width:80px;" value="<?=$datenow?>"/>
							</p></td>
