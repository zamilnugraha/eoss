	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:15px;">
		<div class="row">
				...
				<td>
							...
							&nbsp;&nbsp; Date  From :&nbsp;<br>
							<input type="text" id="dtfrom_sc" name="dtfrom_sc" class="date start" style="margin-left:15px;width:48%;"/>  							
							</p></td>
				
							<td><p id="dtto_sc" name="dtto_sc" style="font-size:10pt;">
							&nbsp;&nbsp; Date To :&nbsp;<br>
							<input type="text" id="dtto_sc" name="dtto_sc" class="date end" style="margin-left:15px;width:48%;"/>
							</p><button id="filter" class="filter" value="Submit" style="float:right;">Submit</button></td>					
...
<div id="dialog-mprdetail" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-header">
		<button type="button" class="close" data-dismiss="modal" aria-hidden="true" title="Close This Form"> X </button>
		<h3 id="myModalLabel">Add Data Detail</h3>
	</div>
	<div class="modal-body"><p>Please wait, data is being retrieved from the database...</p></div>
	<div class="modal-footer" style="margin-top:-20px;">
		<button type="submit" id="simpan-mprdetail" class="btn btn-success" onClick="sukses()" title="Save To Database">Save</button>
		<button class="btn btn-danger" data-dismiss="modal" aria-hidden="true" title="Close This Form">Close</button>
	</div>
</div>

<div id="dialog-mprdetailview" class="modal hide fade" style="width:95%;display:block;margin-left:-430px;" tabindex="-1" role="dialog" aria-labelledby="myModalLabelview" aria-hidden="true">
	<div class="modal-header">
		<!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> X </button>-->
		<button class="btn btn-danger" style="float:right;" data-dismiss="modal" aria-hidden="true">Close</button>
		<h3 id="myModalLabelview">Add Data Detail</h3>
	</div>
	<div class="modal-body-view"></div>
	<div class="modal-footer"></div>
</div>

<div id="dialog-mprdetailviewfile" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabelviewfile" aria-hidden="true">
	<div class="modal-header">
		<!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> X </button>-->
		<button class="btn btn-danger" style="float:right;" data-dismiss="modal" aria-hidden="true">Close</button>
		<h3 id="myModalLabelviewfile">View / Upload File PDF</h3>
	</div>
	<div class="modal-body-viewfile"></div>
	<div class="modal-footer"></div>
</div>

<div id="dialog-mprdetailviewfileimg" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabelviewfileimg" aria-hidden="true">
	<div class="modal-header">
		<!--<button type="button" class="close" data-dismiss="modal" aria-hidden="true"> X </button>-->
		<button class="btn btn-danger" style="float:right;" data-dismiss="modal" aria-hidden="true">Close</button>
		<h3 id="myModalLabelviewfileimg">View / Upload File Images</h3>
	</div>
	<div class="modal-body-viewfileimg"></div>
	<div class="modal-footer"></div>
</div>
