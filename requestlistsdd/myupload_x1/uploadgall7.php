...
$gallery_name7 = $_FILES["myfile"]["name"];
$gallery_size7 = $_FILES["myfile"]["size"];
$gallery_location7 = '/dc9144e0ece8bcd25dd3a4dcb7b305a3/picture/gallery/data_'.$id_talentdetail.'/';
...
if(isset($_FILES["myfile"])){
    ...
    if(move_uploaded_file($_FILES["myfile"]["tmp_name"],$output_dir. $gallery_name7))
	{		
		mysql_query("UPDATE talent_detail SET gallery_name7='$gallery_name7', gallery_location7='$gallery_location7', gallery_size7='$gallery_size7' WHERE id_talentdetail='$id_talentdetail' ");
    }else{
		echo "Gagal Uplaod";
	}
