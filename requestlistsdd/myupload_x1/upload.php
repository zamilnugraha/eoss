...
$upload_filerealname = $_FILES["myfile"]["name"];
...
$upload_filelocation = 'http://'.$_SERVER['SERVER_NAME'].'/transmediamprx/uploaded/mediarelations/data_'.$id_mediarelation.'/';
...
if(isset($_FILES["myfile"]))
{
	...
	{		
		mysql_query("UPDATE tblmediarelation SET upload_filerealname='$upload_filerealname', upload_filename='$new_file_name', 
