												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_TIPEBARANG_KODE.ticket_needassist IN('NO') AND
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						JOIN ITH_TICKET_HEADER ON ITH_TIPEBARANG_KODE.TICKET_ID = ITH_TICKET_HEADER.TICKET_ID
																						JOIN ITH_USER ON ITH_TICKET_HEADER.TICKET_CREATEBY = ITH_USER.USER_NIK
																						WHERE ITH_TIPEBARANG_KODE.TICKET_ID = '".$_GET['pid']."' AND ITH_TIPEBARANG_KODE.TICKET_NEEDASSIST = 'NO'
																						AND 
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? if(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->received_date=='')){ ?>
																		...
																		?>
																			...
																			<p name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					...
																					<? 
																						$qSelectTeknisiNamedefault = mysql_query("SELECT * FROM ITH_TIPEBARANG_KODE WHERE ticket_id = '".$_GET['pid']."'");
																					...
																					<? 
																						$qSelectTeknisiName = mysql_query("SELECT user_nik, user_realname, udept_id, userdepartemen_id, nama_jabatan FROM ITH_USER 
																														   WHERE udept_id LIKE '%FSD%' AND userdepartemen_id = 'FSD WEST' AND userlevel_id = '22' 
																														   AND nama_jabatan IN('Supervisor Teknisi','Coordinator Teknisi','Teknisi') ORDER BY user_realname ASC");
																						while($rSelectTeknisiName = mysql_fetch_object($qSelectTeknisiName)){
																					?>
																						<option value="<?=$rSelectTeknisiName->user_realname?>"><?=$rSelectTeknisiName->user_realname.' ('.$rSelectTeknisiName->nama_jabatan.')'?></option>
																					<? } ?>
																					</select>
																			</p>
																			<script>
																...
																<? }elseif(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->received_date!='')){ ?>
																		...
																		&nbsp;&nbsp;<b>Delivered&nbsp;From&nbsp;:</b>&nbsp;&nbsp;<?=strtoupper($rCekDataInputan->pictakein_by)?>	
																	<? } ?>			
