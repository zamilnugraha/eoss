<?
								echo "<center><b><br>Food Processing EQ</b></center><hr>";
										...
										if($rCekJmlBrg->Tbarang==1)
										{
											...
											{													
												...
												***/
													...
													echo "<hr><br> Nama Barang (FOOD PROCESSING EQ) = ".$rCekJmlBrgXX->nama_tipebarang.'<hr>';
													echo "<br>
										...
										}elseif($rCekJmlBrg->Tbarang > 1)
										{
											...
											{													
												...
												***/
													...
													{
														echo "<br><br><b>FOOD PROCESSING EQ SUKSES STATUS NOT APPROVAED</b>";
													...
													{
														echo "<br><br><b>FOOD PROCESSING EQ GAGAL STATUS NOT APPROVAED</b>";
														echo "<br>Value Kode Barang : $value_kdtipebrg";
														echo "<br>Value Kode Barang By Query : $rCekJmlBrgXX->kode_tipebarang";												
														echo "<br><br>";
													}													
											...
											**/
												...
												if($value_kdtipebrg == $rCekJmlBrgXX->kode_tipebarang)
												{
													echo "<br><br><b>FOOD PROCESSING EQ SUKSES STATUS APPROVAED</b>";
													echo "<br>Value Kode Barang : $value_kdtipebrg";
													echo "<br>Value Kode Barang By Query : $rCekJmlBrgXX->kode_tipebarang";											
													echo "<br><br>";
												}elseif($value_kdtipebrg != $rCekJmlBrgXX->kode_tipebarang)	
												{
													echo "<br><br><b>FOOD PROCESSING EQ GAGAL STATUS APPROVAED</b>";
													echo "<br>Value Kode Barang : $value_kdtipebrg";
													echo "<br>Value Kode Barang By Query : $rCekJmlBrgXX->kode_tipebarang";											
													echo "<br><br>";
												}												
...
";	
												/*
													...
													<br>ticketapproval_id2 = '".$_SESSION['nik_atasan']."',
													<br>ticketapproval_by2 = '".$_SESSION['nama_atasan']."',													
													<br>ticketapproval_createdate = '".$ticketapproval_createdate1."',
													<br>ticketapproval_createtime= '".$ticketapproval_createdate1."',
													<br>ticketapprovalstatus_id2 = '2'
													<br>WHERE ticket_id = '".$pid."'";	
