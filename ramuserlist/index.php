...
<form id="formfilter">				
				...
				<table class="table table-hover" cellpadding="0" cellspacing="0" style="border:0;">				
						<tr>
									...
									<td>
										<a href='<?="http://".$_SERVER['SERVER_NAME']."/index.php?view=new_amuser"?>' title='New AM User' target='_parent'><img src='img/adduser.jpg' alt='' height='20' width='40'></img></a>
									</td>									
						</tr>
						...
						<tr>
									...
									<td>
										...
										<?
											...
											GROUP BY usergroup_kd,usersubgroup_kd ORDER BY usergroup_kd,usersubgroup_kd ASC");
											while($rvareafrom = mysql_fetch_object($qvareafrom)){
										?>											
											<option value="<?=$rvareafrom->usersubgroup_kd?>"><?=ucwords(strtoupper($rvareafrom->usersubgroup_name))?></option>
											<? } ?>
			...
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					<font size="4">&nbsp;List Area Manager (AM)</font>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											...
											<th style="background-color:#909090;color:#fff;border-color:white;width:80px;text-align:center;">AM User<br>Name</th>
										...
										<!--<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">NIK<br>Atasan</th>0-->
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">ROM<br>Name<br></th>
