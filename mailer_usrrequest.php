<?php
	...
	*/
	...
	$mail->Subject    = "[E-OPERATION SUPPORT PROGRAM].USER-REQUEST : $ticket_subject";
	$mail->AltBody    = "$ticket_subject"; 
	
	$mail->Body = "
	Terimakasih Karena Telah Membuat Permintaan didalam aplikasi servicedesk ini,berikut infonya :<br>
		<ul>
			<li>Request ID : $newid</li>
			<li>Request By : $ticket_createbyname</li>
			<li>Kategori : -</li>
			<li>Subject : $ticket_subject</li>
			<li>Status : Open</li>
			<li>Ticket Create date : $cdate</li>
			<li>Nama Barang 1 : $namabarangs1a</li>
			<li>Jumlah Barang 1 : $qtycold Unit</li>
			<li>Nama Barang 2 : $namabarangs2a</li>
			<li>Jumlah Barang 2 : $qtyheat Unit</li>
			<li>Nama Barang 3 : $namabarangs3a</li>
			<li>Jumlah Barang 3 : $qtyfoodprocessing Unit</li>
		</ul>
	<hr>
	Comment	:	<br>$ticket_problem<br><br>
	<hr>
							View Detail <br> Silahkan masukkan Username dan password dengan menggunakan User NIK Anda<br>
							Please Click In Here (<a href='http://localhost/eoss/?view=comment&pid=$newid&uid=$usrnik'>Silahkan Di Klik</a>)
