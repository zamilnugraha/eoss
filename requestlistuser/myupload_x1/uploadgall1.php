...
$gallery_name = $_FILES["myfile"]["name"];
$gallery_size = $_FILES["myfile"]["size"];
$gallery_location = '/dc9144e0ece8bcd25dd3a4dcb7b305a3/picture/gallery/data_'.$id_talentdetail.'/';
...
if(isset($_FILES["myfile"])){
    ...
    if(move_uploaded_file($_FILES["myfile"]["tmp_name"],$output_dir. $gallery_name))
	{		
		mysql_query("UPDATE talent_detail SET gallery_name='$gallery_name', gallery_location='$gallery_location', gallery_size='$gallery_size' WHERE id_talentdetail='$id_talentdetail' ");
    }else{
		echo "Gagal Uplaod";
	}
