...
<div id="content" style="height:1560px;">
	<div class="header">
<? if(($_SESSION['user_level']==100)||($_SESSION['user_level']==101)||($_SESSION['user_level']==102)||($_SESSION['user_level']==103)||($_SESSION['user_level']==104)){?>
	<!--<h3>Daftar PeLaporan</h3>-->
<? }elseif($_SESSION['user_level']==1){?>
	<!--<h3>PeLaporanku X1</h3>-->
<? } ?>
	</div>
    ...
    <div class="body" style="height:1250px;">
		...
		<? if(($_SESSION['udeptid']=='IT')||($_SESSION['udeptid']=='GENERAL MANAGER')){?>
			<? if($_SESSION['user_level']==100){?>
				<iframe src="requestlist/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? }elseif(($_SESSION['user_level']==1)||($_SESSION['user_level']==21)||($_SESSION['user_level']==1000)||($_SESSION['user_level']==1001)){?>
				<iframe src="requestlistuser/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? } ?>
		<? }elseif($_SESSION['udeptid']=='FSD'){?> 
			<? if($_SESSION['user_level']==101){?>
				<iframe src="requestlistfsd/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? }elseif(($_SESSION['user_level']==1)||($_SESSION['user_level']==22)||($_SESSION['user_level']==1000)||($_SESSION['user_level']==1001)){?>
				<iframe src="requestlistuser/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? } ?>
		<? }elseif($_SESSION['udeptid']=='SDD'){?> 
			<? if($_SESSION['user_level']==102){?>
				<iframe src="requestlistsdd/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? }elseif(($_SESSION['user_level']==1)||($_SESSION['user_level']==23)||($_SESSION['user_level']==1000)||($_SESSION['user_level']==1001)){?>
				<iframe src="requestlistuser/index.php" frameborder="0" width="100%" scrolling="no" height="1500px"></iframe>
			<? } ?>		
		<? }elseif($_SESSION['user_departemen']=='OPERATIONAL_STORE' || $_SESSION['user_departemen']=='OPR EAST'){ ?>
				<iframe src="requestlistuser/index.php" frameborder="0" width="100%" scrolling="no" height="1500px" style="background:transparent;margin-top:-30px;"></iframe>
		<? } ?>
		</div>
    </div>
</div>
