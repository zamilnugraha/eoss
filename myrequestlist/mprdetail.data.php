		...
		or isset($_POST['statusticket_sc']) or isset($_POST['supportby_sc']) AND isset($_POST['halaman'])) 
		{
				...
				if(($_SESSION['user_level'] == 1)){				
					...
					{	
						...
						AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
						ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6')
					...
					/**	
						echo "
						SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
						LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
						LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
						LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
						LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
					...
					**/
							if($_POST['statusticket_sc']=='6')
							{
								if($_POST['supportby_sc']=='6'){
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
											ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7')
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='1'){
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
									...
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
											ITH_TICKET_HEADER.ticket_udeptid = '2'
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='3'){
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
											ITH_TICKET_HEADER.ticket_udeptid = '3'
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='4'){
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
											ITH_TICKET_HEADER.ticket_udeptid = '4'
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='7'){
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
											ITH_TICKET_HEADER.ticket_udeptid IN ('2','3')
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}
							}elseif($_POST['statusticket_sc']=='1')
							...
							}elseif($_POST['statusticket_sc']=='2')
							{
								if($_POST['supportby_sc']=='6'){		
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id = '2' AND
											ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7')
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='1'){		
								...
								if($_POST['supportby_sc']=='6'){		
									$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
											...
											LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
											WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
											AND ITH_TICKET_HEADER.ticketstatus_id = '3' AND
											ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7')
											$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
											ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
								}elseif($_POST['supportby_sc']=='1'){		
						...
						if($_POST['supportby_sc']=='6'){		
							$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
									...
									LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
									WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
									AND ITH_TICKET_HEADER.ticketstatus_id = '0' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
						}elseif($_POST['supportby_sc']=='1'){		
						...
						if($_POST['supportby_sc']=='6'){		
							$query = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
									...
									LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
									WHERE (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
									AND ITH_TICKET_HEADER.ticketstatus_id = '5' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
						}elseif($_POST['supportby_sc']=='1'){		
					...
					LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
					LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
					WHERE ((ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') OR 
					(ITH_TICKET_HEADER.ticket_subject LIKE '%$kunci%') OR 
					(ITH_USER.user_realname LIKE '$kunci%'))
					AND ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5') AND
					ITH_TICKET_HEADER.ticket_udeptid ='1' 
					$romfromto_query $areafromto_query $storefromto_query $dtfromto_query 
					ORDER BY ITH_TICKET_HEADER.ticket_no DESC LIMIT 0, $jml_per_halaman");
	...
	<? }elseif(isset($_POST['halaman']) or (isset($_POST['cari']) or isset($_POST['romfrom_sc']) or isset($_POST['romto_sc']) 
		...
		<!--?='ini halaman ='.$_POST['halaman'].'<br>';?--->
			...
			<tbody>
					...
					}elseif(($_SESSION['user_level'] == 99)||($_SESSION['user_level'] == 1000)||($_SESSION['user_level'] == 1001)||($_SESSION['user_level'] == 1002))
					{
						if($_SESSION['udeptid']=='GENERAL MANAGER')
						{
							$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
							LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
							 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
							 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
							WHERE ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
							$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
							ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
							
							#echo "<br>jml_data = ".$jml_data.'<br>';
							
							if($_SESSION['statusticket']=='6'){	
								if($_SESSION['supportby']=='6'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5','6') AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
								
								}elseif($_SESSION['supportby']=='1'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									...
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
								}elseif($_SESSION['supportby']=='3'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5','6') AND
									ITH_TICKET_HEADER.ticket_udeptid = '3' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
								}elseif($_SESSION['supportby']=='4'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5','6') AND
									ITH_TICKET_HEADER.ticket_udeptid = '4' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
								}elseif($_SESSION['supportby']=='7'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
								...
								if($_SESSION['supportby']=='6'){
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='1' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='1'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 ...
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='1' AND
									ITH_TICKET_HEADER.ticket_udeptid = '2' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='3'){
									$jml_data = mysql_num_rows(mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_USER.user_realname, ITH_TICKETSTATUS.ticketstatus_name FROM ITH_TICKET_HEADER 
								...
								if($_SESSION['supportby']=='6'){
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='2' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query									
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='1'){
								...
								if($_SESSION['supportby']=='6'){
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='3' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='1'){
								...
								if($_SESSION['supportby']=='6'){
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='0' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='1'){
								...
								if($_SESSION['supportby']=='6'){
									...
									LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
									 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
									 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
									WHERE ITH_TICKET_HEADER.ticketstatus_id ='5' AND
									ITH_TICKET_HEADER.ticket_udeptid IN('1','2','3','4','6','7') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
									$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
									ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								}elseif($_SESSION['supportby']=='1'){
						...
						}elseif($_SESSION['udeptid']=='IT')
						{
							if($_SESSION['statusticket']=='6'){	
								...
								LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
								 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
								 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
								WHERE ITH_TICKET_HEADER.ticketstatus_id ='1' AND ITH_TICKET_HEADER.ticket_udeptid ='1'
								$romfromto_query $areafromto_query $storefromto_query $dtfromto_query								
								ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								###echo "<br>Jumlah Data II = ".$jml_data.'<br>';
							}elseif($_SESSION['statusticket']=='2'){	
						...
						}elseif($_SESSION['udeptid']=='FSD')
						{
							if($_SESSION['statusticket']=='6'){	
								...
								LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
								 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
								 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
								WHERE ITH_TICKET_HEADER.ticketstatus_id ='1' AND ITH_TICKET_HEADER.ticket_udeptid IN('2','3')
								$romfromto_query $areafromto_query $storefromto_query $dtfromto_query								
								ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								###echo "<br>Jumlah Data II = ".$jml_data.'<br>';
							}elseif($_SESSION['statusticket']=='2'){	
						...
						}elseif($_SESSION['udeptid']=='SDD')
						{
							if($_SESSION['statusticket']=='6'){	
								...
								LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
								 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
								 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
								WHERE ITH_TICKET_HEADER.ticketstatus_id ='1' AND ITH_TICKET_HEADER.ticket_udeptid ='4'
								$romfromto_query $areafromto_query $storefromto_query $dtfromto_query								
								ORDER BY ITH_TICKET_HEADER.ticket_no DESC"));
								###echo "<br>Jumlah Data II = ".$jml_data.'<br>';
							}elseif($_SESSION['statusticket']=='2'){	
						...
						if($_SESSION['statusticket']=='6'){	
							...
							LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
							 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
							 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
							WHERE ITH_TICKET_HEADER.ticket_udeptid = '1' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
							$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
							ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
							###echo "<br>Jumlah Data II = ".$jml_data.'<br>';								
						}elseif($_SESSION['statusticket']=='1'){	
						...
						if($_SESSION['statusticket']=='6'){	
							...
							LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
							 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
							 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
							WHERE ITH_TICKET_HEADER.ticket_udeptid IN ('2','3') AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
							$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
							ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
							###echo "<br>Jumlah Data II = ".$jml_data.'<br>';								
						}elseif($_SESSION['statusticket']=='1'){	
						...
						if($_SESSION['statusticket']=='6'){	
							...
							LEFT JOIN ITH_TICKETSTATUS ON ITH_TICKET_HEADER.ticketstatus_id = ITH_TICKETSTATUS.ticketstatus_id
							 LEFT JOIN ITH_TICKETCATEGORYNEW ON ITH_TICKET_HEADER.ticketsubcategory_code = ITH_TICKETCATEGORYNEW.ticketsubcategory2_code
							 LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik
							WHERE ITH_TICKET_HEADER.ticket_udeptid = '4' AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%')
							$romfromto_query $areafromto_query $storefromto_query $dtfromto_query
							ORDER BY ITH_TICKET_HEADER.ticket_no DESC")); 
							###echo "<br>Jumlah Data II = ".$jml_data.'<br>';								
						}elseif($_SESSION['statusticket']=='1'){	
				...
				###	echo "<br>Jumlah Data II New = ".$jml_data.'<br>';
							...
							if(($_SESSION['user_level'] == 1)){				
								...
								*/		
								...
								if(($_SESSION['user_level'] == 1000)||($_SESSION['user_level'] == 1001)||($_SESSION['user_level'] == 1002)||($_SESSION['user_level'] == 99))
								{
										...
										if($_SESSION['statusticket']=='6'){
											if($_SESSION['supportby']=='6'){
												$queryx = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
														...
														LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
														LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
														WHERE ITH_TICKET_HEADER.ticketstatus_id IN ('1','2','3','0','5')
														AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4','6','7') 												  
														AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
														$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
											...
											if($_SESSION['supportby']=='6'){
												$queryx = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
														...
														LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
														LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
														WHERE ITH_TICKET_HEADER.ticketstatus_id = '1'
														AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4','6','7') 												  
														AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
														$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
														ORDER BY ITH_TICKET_HEADER.ticket_no ASC LIMIT 0, $jml_per_halaman");
											...
											if($_SESSION['supportby']=='6'){
												$queryx = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
														...
														LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
														LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
														WHERE ITH_TICKET_HEADER.ticketstatus_id = '2'
														AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4','6','7') 												  
														AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
														$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
														ORDER BY ITH_TICKET_HEADER.ticket_no ASC LIMIT 0, $jml_per_halaman");
											...
											if($_SESSION['supportby']=='6'){
												$queryx = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
														...
														LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
														LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
														WHERE ITH_TICKET_HEADER.ticketstatus_id = '3'
														AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4','6','7') 												  
														AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
														$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
														ORDER BY ITH_TICKET_HEADER.ticket_no ASC LIMIT 0, $jml_per_halaman");
											...
											if($_SESSION['supportby']=='6'){
												$queryx = mysql_query("SELECT ITH_TICKET_HEADER.*, ITH_TICKETSTATUS.ticketstatus_name, ITH_USER.user_realname, ITH_USERGROUP.usergroup_name, ITH_USERGROUP.usersubgroup_name, ITH_USERGROUP.usersubgroup2_name FROM ITH_TICKET_HEADER 
														...
														LEFT JOIN ITH_USER ON ITH_TICKET_HEADER.ticket_createby = ITH_USER.user_nik	
														LEFT JOIN ITH_USERGROUP ON ITH_USER.userlevel_id = ITH_USERGROUP.userlevel_id
														WHERE ITH_TICKET_HEADER.ticketstatus_id = '5'
														AND ITH_TICKET_HEADER.ticket_udeptid IN ('1','2','3','4','6','7') 												  
														AND (ITH_TICKET_HEADER.ticket_id LIKE '%$kunci%') 
														$romfromto_query $areafromto_query $storefromto_query $dtfromto_query $tktsts_query
														ORDER BY ITH_TICKET_HEADER.ticket_no ASC LIMIT 0, $jml_per_halaman");
					...
					if(($_SESSION['user_level'] == 1000)||($_SESSION['user_level'] == 1001)||($_SESSION['user_level'] == 1002)||($_SESSION['user_level'] == 99))
					{
						...
						{
							/** // Info Data //
							echo "<br>General Manager<br>";
							echo "Halaman = ".$halaman;
							echo "<br>jumlah Per Halaman = ".$jml_per_halaman;
							
							echo "<br>Jumlah Data = ".$jml_data;
							echo "<br>Status Tiket = ".$_SESSION['statusticket'];
							echo "<br>Support By = ".$_SESSION['supportby'];
							**/
