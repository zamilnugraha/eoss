	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:15px;">
		<div class="row">
				...
				?>				
							...
							&nbsp;&nbsp; Date  From :&nbsp;<input type="text" id="dtfrom_sc" name="dtfrom_sc" class="date start" style="margin-left:15px;width:48%;" placeholder="<?=$mydate?>"/>  							
							</p></td>
				
							<td><p id="dtto_sc" name="dtto_sc" style="font-size:10pt;">
							&nbsp;&nbsp; To :&nbsp;<input type="text" id="dtto_sc" name="dtto_sc" class="date end" style="margin-left:15px;width:48%;"placeholder="<?=$datenow?>"/>
							</p></td>
