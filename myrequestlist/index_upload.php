...
<form id="formfilter">				
           ...
           <!-- <td><label style="width:80px; margin-left:0px;">Support By :</label></td>
			...
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					<font size="4" class="thumbnail">&nbsp;List Request</font>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
											...
											<th style="background-color:#909090;color:#fff;border-color:white;width:5px;text-align:center;">Image</th>
                                        </tr>
                                    </thead>
...
<div style="width:900px;left:32%;" class="modal fade"  id="modal-gallery" role="dialog">
      ...
      <div class="modal-body">
          <div id="modal-carousel" class="carousel">
            ...
            <div class="carousel-inner" id="carousel-inner">     
				<!-- #image-1 
		<div class="item active" id="image-1" style="align:center;">
			<img class="thumbnail img-responsive" style="display: block; margin: 0 auto;" title="Image 11" src="../uploads/OTRAFI/OTRAFI_0.jpeg">
		</div>
		<div class="item" id="image-1">
			<img class="thumbnail img-responsive" title="Image 12" src="../uploads/OTRAFI/OTRAFI_1.jpg">
		</div>
		<div class="item" id="image-1">
			<img class="thumbnail img-responsive" title="Image 13" src="../uploads/OTRAFI/OTRAFI_2.png">
		</div>-->
...
function openCarousel(ticketId){
	$.ajax({
		url: "../uploads/"+ticketId,
		success: function(data){
			var i=0;
			var html="";
			$(data).find("a:contains(.jp)").each(function(){
				var images = $(this).attr("href");
				html +="<div class=\"item "+(i===0?'active':'')+"\" id=\"image-"+i+"\" style=\"align:center;\">"
				+"<img class=\"thumbnail img-responsive\" style=\"display: block; margin: 0 auto;\"  src=\"../uploads/"+ticketId+"/"+images+"\">"
				+"</div>";
				//alert(html);
				i++;
			});
		...
		error:function(){
			alert("Tidak terdapat file dengan nomor tiket "+ticketId);
		}
	});	
	...
	/* when clicking a thumbnail */
        ...
        myTable = $('#dataTables-example').DataTable({
				...
				columns: [
					...
					{"data": "requestBy"},
					{"data": "subject"},
					(login>=1000?{"data": "statusApproval"}:{"data": "status"}),
					{"data": "reqVia"},
					{"data": "supportBy"},
					{"data": "",
						"bSortable": false,
					...
					{"data": "",
					  ...
					  "mRender": function(data, type, full) {
						  ...
						  if(login !=1 && login<1000 && (full.ticketRef==1 && full.status=='Open')){							  
						  ...
						  if(login>=1000 && full.statusApprovalId ==2 && full.myApproval==1 && (full.status=='Open' || full.status=='On Process')){							  
					...
					{"data": "",
						"bSortable": false,
						"mRender": function(data, type, full) {
						  var link = "<a href='javascript:void(0)' onclick=\"openCarousel('"+full.ticketId+"')\" title='Ticket ID: "+full.ticketId+"' >"
								+"<img src='../images/dir_galery.jpg' alt='' height='50' width='50'></img>"
								+"</a>";
