<!-- FROM FILE approval_from_mail.php -->
<? 
...
?>
	...
	{ ?>
		...
		<? 
			$qCekStatusKeteranganData = mysql_query("SELECT ITH_USER.user_realname, ITH_TIPEBARANG_KODE.keterangan,ITH_TIPEBARANG_KODE.ticket_needassist,ITH_TIPEBARANG_KODE.ticket_id, 
										ITH_TIPEBARANG_KODE.tickettransferto_outletcode, ITH_TIPEBARANG_KODE.request_by,ITH_USER.userstoregroup_id
			...
			$qCekStoreNameReq = mysql_query("SELECT * FROM ITH_USER WHERE user_nik = '".$detailmyticketKeteranganData->userstoregroup_id."'");
			$rCekStoreNameReq = mysql_fetch_object($qCekStoreNameReq);
		?>
		...
		<? }elseif(($detailmyticketKeteranganData->keterangan=='MOVE TO WAREHOUSE')){ ?>
			...
			<? if($detailmyticketKeteranganData->ticket_needassist=='YES'){ //ASSIGN TECHNICIAN FROM FSD MANAGER ?>
				<? if($_SESSION['departemen_id']==5){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM STORES TO FSD TECHNICIANS<!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI --> </u></b></font>
				<? }elseif($_SESSION['departemen_id']==3){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM FSD TECHNICIANS TO FSD WAREHOUSE<!--SERAH TERIMA BARANG DARI TEKNISI KE WAREHOUSE STAFF --> </u></b></font>
				<? } ?>
			<? }elseif(($detailmyticketKeteranganData->ticket_needassist=='YES')||($detailmyticketKeteranganData->ticket_needassist=='NO')){ //ASSIGN TECHNICIAN FROM FSD MANAGER ?>
				<? if($_SESSION['departemen_id']==5){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM STORES TO FSD TECHNICIANS<!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI --> </u></b></font>
				<? }elseif($_SESSION['departemen_id']==3){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM FSD TECHNICIANS AND OPR TECHNICIAN TO FSD WAREHOUSE<!--SERAH TERIMA BARANG DARI TEKNISI KE WAREHOUSE STAFF --> </u></b></font>
				<? } ?>
			<? }elseif($detailmyticketKeteranganData->ticket_needassist=='NO'){ //ASSIGN TECHNICIAN FROM OPR MANAGER ?>
			<!--<font color="#ffffff"><b><u>ASSIGNMENT OF TECHNICAL PERSONS BY THE OPERATION MANAGER </u></b></font>-->
				<? if($_SESSION['departemen_id']==5){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM STORES TO OPERATION TECHNICIANS<!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI --> </u></b></font>
				<? }elseif($_SESSION['departemen_id']==3){ ?>
					<font color="#ffffff"><b><u>WILL RECEIVE GOODS FROM OPERATION TECHNICIANS TO FSD WAREHOUSE<!--SERAH TERIMA BARANG DARI TEKNISI KE WAREHOUSE STAFF --> </u></b></font>
				<? } ?>
		...
		<? if($rvCekDataHeaderEQx->REQUEST_BY == $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=odtrf&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST">
					<table class="blueTable" border="1"> 
						<thead>
							<tr>
								...
								?>														
									<th width="18%" style="color:#ffffff;">Item Request XXX</th>
									...
									<th width="26%" style="color:#ffffff;">Received&nbsp;By And Date</th>							
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_TIPEBARANG_KODE.received_date IN('','-') AND
																						ITH_TIPEBARANG_KODE.ticket_needassist IN('YES','NO') AND
																						(ITH_TIPEBARANG_KODE.ticketapprovalstatusid_am = '1' AND 
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																<div style="margin-left:20px;color:brown;font-weight:bold;"><?=$rvCekDataEQx["KODE_TIPEBARANG"].' - '.$rvCekDataEQx["NAMA_TIPEBARANG"];?>
																  ...
																  <? }elseif($cekItemName == 'NEW'){ ?>	
																   ...
																   ?>
																		...
																		<li><b> Book Age : <?=$rvSCatReplaceOldItem->UMURBUKUOLDITEM?></b></li> 
																		<li><b> Book Value : <font color="brown"><?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->NILAIBUKUOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>
																		<!--<li><b> New Price Z : <font color="brown"><!?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->ITEMPRICEOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>-->
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<!--<li><b> New Price X : <font color="brown"><!?='<strong>Rp.&nbsp;'.number_format($rvSCatReplace2->ITEMPRICEREPLACE, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>-->
																...
																<? 
																	$qCekDataInputan = mysql_query("SELECT received_by, received_date, tickettransferto_outletcode, tickettransferto_outletname 
																									FROM ITH_TIPEBARANG_KODE 
																									WHERE ticket_id ='".$_GET['pid']."' AND tickettransferto_outletcode = '".$_GET['uid']."'");
																...
																<? }elseif($rCekDataInputan->received_date!=''){ ?>	
																	&nbsp;&nbsp;<b>Item&nbsp;Status&nbsp; W2 :</b>&nbsp;&nbsp;<?='Transferred By Store '.ucwords(strtolower($rCekDataInputan->tickettransferto_outletname))?><br>
																	&nbsp;&nbsp;<b>Transferred&nbsp;Date&nbsp;:</b>&nbsp;&nbsp;<?=$rCekDataInputan->received_date?><br>
		...
		<? }elseif($rvCekDataHeaderEQx->REQUEST_BY != $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
				<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;"> 
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=awrcv&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST" height="auto">
					<table class="blueTable" border="1"> 
						<thead>
							<tr>
								<?  
									$objConnect = oci_connect('fsd', 'fsd', 'localhost:1521/XE'); 
								?>														
									<th width="18%" style="color:#ffffff;">Item Request ZZZ</th>
									<th width="7%" style="color:#ffffff;">Date Of<br>Request</th>									
									<!--<th width="5%" style="color:#ffffff;">Transfer<br>To</th>-->						
									<th width="25%" style="color:#ffffff;">Approval<br>Status</th>	
									<th width="7%" style="color:#ffffff;">Transfer<br>To</th>	
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						JOIN ITH_USER ON ITH_TICKET_HEADER.TICKET_CREATEBY = ITH_USER.USER_NIK
																						WHERE ITH_TIPEBARANG_KODE.TICKET_ID = '".$_GET['pid']."' 
																						AND ITH_TIPEBARANG_KODE.TICKET_NEEDASSIST IN('YES','NO')
																						AND 
																						(ITH_TIPEBARANG_KODE.ticketapprovalstatusid_am = '1' AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_rom = '1' AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_gmo = '1');
																						");
															###$rvCekDataEQ = mysql_fetch_object($qvCekDataEQ);												
															#echo "<br>Nomer Permintaan : ".$rvCekDataEQ->no_permintaan;
															$objConnectShowEQ = oci_connect('fsd', 'fsd', 'localhost:1521/XE');
												...
												}elseif(($rCekStatusTiketStore->ticketapprovalstatus_id3=='1')||($rCekStatusTiketStore->ticketapprovalstatus_id2=='1')||($rCekStatusTiketStore->ticketapprovalstatus_id=='1'))
												{
														...
														***/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						WHERE ITH_TIPEBARANG_KODE.TICKET_ID = '".$_GET['pid']."' 
																						AND ITH_TIPEBARANG_KODE.TICKET_NEEDASSIST IN('YES','NO')
																						AND ITH_TIPEBARANG_KODE.received_date IN('','-')
																						AND 
																						(ITH_TIPEBARANG_KODE.ticketapprovalstatusid_am = '1' AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_rom = '1' AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_gmo = '1');
																						");
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																<div style="margin-left:20px;color:brown;font-weight:bold;"><?=$rvCekDataEQx["KODE_TIPEBARANG"].' - '.$rvCekDataEQx["NAMA_TIPEBARANG"];?>
																  ...
																  <ul>
																   ...
																   ?>
																			...
																			<li><font color="#000"><b> Book Age : </font><font color="brown"><?=$rvSCatReplaceOldItem->UMURBUKUOLDITEM?></font></b></li> 
																			<li><font color="#000"><b> Book Value : </font><font color="brown"><?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->NILAIBUKUOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>
																			<!--<li><b> New Price : <font color="brown"><!?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->ITEMPRICEOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>-->
																			<li><font color="#000"><b> Tagging Number : </font><font color="brown"><?=$rvSCatReplaceOldItem->NOTAGINGITEM?></font></b></li>
																		<? 
																			$qCekStatusKeteranganData = mysql_query("SELECT DISTINCT keterangan FROM ITH_TIPEBARANG_KODE 
																													 WHERE ticket_id = '".$_GET['pid']."' AND kode_tipebarang = '".$rvCekDataEQx["KODE_TIPEBARANG"]."'");
																			$detailmyticketKeteranganData = mysql_fetch_object($qCekStatusKeteranganData);
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<td width="7%">
																	<center><b><font color="#000"><?=$rvCekDataEQx["TICKET_CREATEDATE"];?></font></b></center>
																</td>
																...
																<td width="25%">								
																	...
																	<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_AM"]=='0'){ ?>																		
																		<font color="red"><?='&nbsp;&nbsp;<b>Approval Status :&nbsp;&nbsp;Disapproved.</b>';?></font><br>
																	<? } ?>																
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By : </font></b>  <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_AM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_AM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_AM"];?></font><hr>

																<!--</td>
																<td width="20%">-->																	
																	<? if(($rvCekDataEQx["TICKETAPPROVALSTATUSID_AM"]=='1')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='2')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_GMO"]=='-')){ ?>																		
																		<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</b></font><font color="brown">&nbsp;&nbsp;Not Yet Responded.';?></font><br>																
																	<? }elseif(($rvCekDataEQx["TICKETAPPROVALSTATUSID_AM"]=='0')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='2')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_GMO"]=='-')){ ?>																		
																		<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</font><font color="brown">&nbsp;&nbsp;Not Needed.</b>';?></font><br>																
																	<? }elseif(($rvCekDataEQx["TICKETAPPROVALSTATUSID_AM"]=='0')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='-')){ ?>																		
																		<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</font><font color="brown">&nbsp;&nbsp;Not Needed.</b>';?></font><br>
																	<? }elseif(($rvCekDataEQx["TICKETAPPROVALSTATUSID_AM"]=='2')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='-')){ ?>																		
																		<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :</font><font color="brown">&nbsp;&nbsp;-</b>';?></font><br>
																	<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='1'){ ?>																		
																	...
																	<? } ?>																		
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By : </font></b>  <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_ROM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_ROM"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_ROM"];?></font><hr>
																<!--</td>
																<td width="20%">-->																	
																	<? if(($rvCekDataEQx["TICKETAPPROVALSTATUSID_GMO"]=='2')&&($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='1')){ ?>																		
																	...
																	<? }else{ ?> <font color="#000"><?='&nbsp;&nbsp;<b>Approval Status :&nbsp;&nbsp; -</b>';?></font><br>																			
																	<? } ?>																			
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval By : </font></b>  <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALBYNAME_GMO"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Date : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALDATE_GMO"];?></font><br>																	
																	<?='<font color="#000">&nbsp;&nbsp;<b>Approval Time : </font></b> <font color="brown">'.$rvCekDataEQx["TICKETAPPROVALTIME_GMO"];?></font><hr>																</td>																
																<td width="6%">																
																	<? 																			
																		$cekItemName = ucwords(strtolower(substr($rvCekDataEQx["KETERANGAN"],8))); 
																	?>	
																...
																<? 
																	$qCekDataInputan = mysql_query("SELECT ITH_TIPEBARANG_KODE.transfer_by, ITH_TIPEBARANG_KODE.transfer_date, ITH_TIPEBARANG_KODE.kode_tipebarang,
																									ITH_TIPEBARANG_KODE.received_by, ITH_TIPEBARANG_KODE.received_date, ITH_TIPEBARANG_KODE.ticket_needassist, 
																									ITH_TIPEBARANG_KODE.tickettransferto_outletcode, ITH_TIPEBARANG_KODE.tickettransferto_outletname,
																									ITH_USER.user_realname, ITH_TIPEBARANG_KODE.ticketapprovalstatusid_am,
																									ITH_TIPEBARANG_KODE.ticketapprovalstatusid_rom,ITH_TIPEBARANG_KODE.ticketapprovalstatusid_gmo,
																									ITH_TIPEBARANG_KODE.pic_name,ITH_TIPEBARANG_KODE.pictakein_by	
																									FROM ITH_TIPEBARANG_KODE
																									JOIN ITH_USER ON ITH_TIPEBARANG_KODE.request_by = ITH_USER.user_nik	
																									WHERE ITH_TIPEBARANG_KODE.ticket_id ='".$_GET['pid']."' 
																									AND ITH_TIPEBARANG_KODE.received_by IN('','-')
																	...
																	# echo '<hr>KODE TIPE BARANG = '.$rvCekDataEQx["KODE_TIPEBARANG"];	
																	# echo '<br>NEED ASSIST = '.$rCekDataInputan->ticket_needassist;	
																?>
																	<!-- WAREHOUSE RECEIVED --> 
																	<!--? if(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->received_date=='')){ ?-->
																	<? if(($rCekDataInputan->received_date=='')||($rCekDataInputan->received_date=='-')){ ?>
																			<? 
																				$mydate = date('d/m/Y', strtotime('today - 30 days'));
																				#$mydate = date('d/m/Y');
																				/*$mydate = date('d/m/Y', strtotime('today + 30 days'));*/
																				$datenow = date('d/m/Y');
																			?>
																				<!-- AREA MGR ASSIGNMENT (AREA ASSIGNMENT/AM ASSIGNMENT)-->	
																				<input type="hidden" name="kdtipebrg[]" id="<?='kdtipebrg'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" value="<?=$rvCekDataEQx["KODE_TIPEBARANG"]?>"></input>
																				<font color="#000"><b>Received&nbsp;By :</b></font>
																				<?
																				...
																				?>
																					<p style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																						&nbsp;&nbsp; &nbsp;<input type="text" class="date start" style="margin-left:15px;width:70%;" value="<?=$rCekUsrCode->user_realname?>" readonly='readonly' />  							
																					</p><br>
																				<font color="#000"><b>Received&nbsp;Date :</b></font>
																				<p name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																						&nbsp;&nbsp; &nbsp;<input type="text" name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" class="date start" style="margin-left:15px;width:60%;" value=""/><!--?=$datenow?-->  							
																				</p>
																				<font color="#000"><b>Received&nbsp;from :</b></font>
																				<p name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																						&nbsp;&nbsp; &nbsp;
																						<!--<input type="text" name="dttransfer_by[<!?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<!?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="margin-left:15px;width:60%;" value=""/>-->  							
																						<!--<select name="dttransfer_by[<!?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<!?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="margin-left:15px;width:80%;height:auto;">-->
																						<? 
																							$qSelectTeknisiNamedefault = mysql_query("SELECT * FROM ITH_TIPEBARANG_KODE WHERE ticket_id = '".$_GET['pid']."' AND kode_tipebarang = '".$rvCekDataEQx["KODE_TIPEBARANG"]."'");
																							$rSelectTeknisiNamedefault = mysql_fetch_object($qSelectTeknisiNamedefault);
																						?>																					
																						<!--<option value="<!?=$rSelectTeknisiNamedefault->pic_name?>"><!?=$rSelectTeknisiNamedefault->pic_name?></option>-->
																						<!--<option value="<!?=$rSelectTeknisiNamedefault->pictakein_by?>"><!?=$rSelectTeknisiNamedefault->pictakein_by?></option>-->
																						<input type="text" class="date start" name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" style="margin-left:15px;width:70%;" value="<?=$rSelectTeknisiNamedefault->pictakein_by?>" readonly='readonly' />
																	...
																	<!--? }elseif(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->received_date!='')){ ?-->
																	<? }elseif(($rCekDataInputan->received_date!='')||($rCekDataInputan->received_date!='-')){ ?>
																			&nbsp;&nbsp;<b>Received&nbsp;By&nbsp;  :</b>&nbsp;&nbsp;<?=strtoupper($rCekDataInputan->received_by)?><br>
																			&nbsp;&nbsp;<b>Received&nbsp;Date&nbsp;:</b>&nbsp;&nbsp;<?=$rCekDataInputan->received_date?><br>
																			&nbsp;&nbsp;<b>Received&nbsp;From&nbsp;F1:</b>&nbsp;&nbsp;<?=strtoupper($rCekDataInputan->pictakein_by)?>	
																	<? } ?>			
																<? } ?>			
