...
?>
	...
	{ ?>
		...
		<? }elseif(($detailmyticketKeteranganData->keterangan=='MOVE TO WAREHOUSE')){ ?>
			...
			<font color="#ffffff"><b><u>TRANSFER ITEM FROM STORES TO FSD TECHNICIANS <!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI FSD --> </u></b></font>
			<? }elseif($detailmyticketKeteranganData->ticket_needassist=='NO'){ //ASSIGN TECHNICIAN FROM OPR MANAGER ?>
			<font color="#ffffff"><b><u>TRANSFER ITEM FROM STORES TO OPR TECHNICIANS <!--SERAH TERIMA BARANG DARI TOKO KE TEKNISI OPR --> </u></b></font>
			<? } ?>
		<? }elseif($detailmyticketKeteranganData->keterangan=='MOVE TO OTHER STORE'){ ?>
			<font color="#ffffff"><b><u>TRANFER MOVEMENT ITEM FROM <?=$detailmyticketKeteranganData->user_realname.' (STORE '.$rCekStoreNameReq->user_realname.')'?> </u></b></font>
		<? } ?>			
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? if(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->transfer_date=='')){ ?>
																		<? 
																		...
																		?>
																			...
																			<font color="#000"><b>Transferred&nbsp;By :</b></font>
																			<?
																			...
																			<font color="#000"><b>Transfer&nbsp;Date :</b></font>
																			...
																			<font color="#000"><b>'Transferred&nbsp;To :</b></font>
																...
																<? }elseif(($rCekDataInputan->ticket_needassist=='NO')&&($rCekDataInputan->transfer_date!='')){ ?>
																		&nbsp;&nbsp;<b>Item&nbsp;Status&nbsp; W1 :</b>&nbsp;&nbsp;<?='Transfer From Store '.ucwords(strtolower($rCekDataInputan->user_realname))?><br>
						...
						<input type="submit" value="SubmitZ" style="margin-left:1020px;" />	
						<? } ?>
					</form>	
					</div>
		<? }elseif($rvCekDataHeaderEQx->REQUEST_BY != $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
				<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;"> 
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=odtrf&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST" height="auto">
					<table class="blueTable" border="1"> 
						<thead>
							<tr>
								<?  
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						JOIN ITH_TICKET_HEADER ON ITH_TIPEBARANG_KODE.TICKET_ID = ITH_TICKET_HEADER.TICKET_ID
																						JOIN ITH_USER ON ITH_TICKET_HEADER.TICKET_CREATEBY = ITH_USER.USER_NIK
																						WHERE ITH_TIPEBARANG_KODE.TICKET_ID = '".$_GET['pid']."' AND ITH_TIPEBARANG_KODE.TICKET_NEEDASSIST = 'YES'
																						AND 
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																?>
																<!-- AREA MANAGER ASSIGNMENT --> 
																<? if(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->transfer_date=='')){ ?>
																		<? 
																			$mydate = date('d/m/Y', strtotime('today - 30 days'));
																			#$mydate = date('d/m/Y');
																			/*$mydate = date('d/m/Y', strtotime('today + 30 days'));*/
																		...
																		?>
																			...
																			<font color="#000"><b>Submitted&nbsp;Date :</b></font>
																			<p name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					&nbsp;&nbsp; &nbsp;<input type="text" name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" class="date start" style="margin-left:15px;width:60%;" value=""/> <!--?=$datenow?-->  							
																			</p>
																			<font color="#000"><b>Submitted&nbsp;To :</b></font>
																			<p name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					&nbsp;&nbsp; &nbsp;
																					<!--<input type="text" name="dttransfer_by[<!?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<!?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="margin-left:15px;width:60%;" value=""/>-->  							
																					<select name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="margin-left:15px;width:80%;height:auto;">
																...
																<? }elseif(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->transfer_date!='')){ ?>
																		&nbsp;&nbsp;<b>Item&nbsp;Status&nbsp; W1 :</b>&nbsp;&nbsp;<?='Transfer From Store '.ucwords(strtolower($rCekDataInputan->user_realname))?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;Date&nbsp;R2:</b>&nbsp;&nbsp;<?=$rCekDataInputan->transfer_date?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;By&nbsp;:</b>&nbsp;&nbsp;<?=strtoupper($transferbyNames)?>		
																	<? } ?>			
						...
						<input type="submit" value="SubmitX" style="margin-left:1020px;" />	
						<? } ?>
					</form>	
					</div>	
				</div>	
