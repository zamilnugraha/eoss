																	...
																	<tr>	
																		 ...
																		 <? } ?>	
																		  ...
																		  <ul>
																		   ...
																		   ?>
																					...
																					<li><b> Book Age : <font color="brown"><?=$rvSCatReplaceOldItem->UMURBUKUOLDITEM?></font></b></li> 
																					<li><b> Book Value : <font color="brown"><?='<strong>Rp.&nbsp;'.number_format($rvSCatReplaceOldItem->NILAIBUKUOLDITEM, $jumlah_desimal, $pemisah_desimal, $pemisah_ribuan)."-".'</strong>';?></font></b></li>
																							<? if(($rvCekDataEQx["KETERANGAN"] =='ADD REQUEST')||($rvCekDataEQx["KETERANGAN"] =='REPLACEMENT REQUEST')){ ?>	
																							...
																							<? }elseif(($rvCekDataEQx["KETERANGAN"] =='MOVE TO OTHER STORE')||($rvCekDataEQx["KETERANGAN"] =='MOVE TO WAREHOUSE')){ ?>	
																								<li><b> Tagging Number : <font color="brown"><?=$rvSCatReplaceOldItem->NOTAGGING;?></font></b></li>
																							<? } ?>
																						<? } ?>
																					<!--? 
																						$qCekStatusKeteranganData = mysql_query("SELECT DISTINCT keterangan FROM ITH_TIPEBARANG_KODE 
																		...
																		<td width="22%">								
																			...
																			<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='1'){ ?>																		
																				<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status : </font><font color="blue"></b>&nbsp;&nbsp;Approved.</b>';?></font><br>
																			<? }elseif($rvCekDataEQx["TICKETAPPROVALSTATUSID_ROM"]=='0'){ ?>																		
																				<font color="#000"><?='&nbsp;&nbsp;<b>Approval Status : </font><font color="brown"></b>&nbsp;&nbsp;Not Approved</b>';?></font><br>
																			<? } ?>																
																																				
																			<?='&nbsp;&nbsp;<font color="#000"><b>Approval By : </font><font color="brown"></b>'.$rvCekDataEQx["TICKETAPPROVALBYNAME_ROM"];?></font><br>																	
																			<?='&nbsp;&nbsp;<font color="#000"><b>Approval Date : </font><font color="brown"></b>'.$rvCekDataEQx["TICKETAPPROVALDATE_ROM"];?></font><br>																	
																			<?='&nbsp;&nbsp;<font color="#000"><b>Approval Time : </font><font color="brown"></b>'.$rvCekDataEQx["TICKETAPPROVALTIME_ROM"];?></font>
																		</td>
																		<td width="25%">
