...
<form id="formfilter">				
				...
				<table class="table table-hover" cellpadding="0" cellspacing="0" style="border:0;">				
						<tr>
									<td><label style="width:70px;display:none;">ROM :</label></td>
									<td>
										<select class="input-small" id="romfrom_sc" name="romfrom_sc" style="width:220px;display:none;">
									...
									<td style="text-align:right;">
										<a href='<?="http://".$_SERVER['SERVER_NAME']."/index.php?view=new_parameter"?>' target='_parent' title="Add Parameter"><img src='../images/newdoc1.jpg' alt='' height='20' width='40'></img></a>
									</td>									
						</tr>
						
						<tr>
									<td><label style="width:70px;display:none;">AREA :</label></td>
									<td>
										<select class="input-small" id="areafrom_sc" name="areafrom_sc" style="width:220px;display:none;">
											<option value="">-- ALL --</option>		
										<?
									...
									<td style="margin-left:0px;display:none;"><label style="width:50px;">To :</label></td>
									<td>
										<select class="input-small" id="areato_sc" name="areato_sc" style="width:220px;display:none;">
											<option value="">-- ALL --</option>
										<?
											if($rvromfrom->usergroup_kd!=''){
										?>	
				...
				<table class="table table-condensed table-bordered table-hover" cellpadding="0" cellspacing="0" style="display:show;">
				<tr>
							<td>							
				...
				<div class="input-prepend pull-right" style="margin-top:-50px;">
						...
						<input class="span2" id="prependedInput" style="width:250px;" type="text" name="pencarian" placeholder="Search By Parameter Name, Parameter Value">
				</div>
		
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					<font size="4">&nbsp;List Paramater Setting</font>
				...
				<center>
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    <thead>
                                        <tr>
                                            <th style="background-color:#909090;color:#fff;border-color:white;width:5px;text-align:center;">No.</th>
											<th style="background-color:#909090;color:#fff;border-color:white;width:80px;text-align:center;">Parameter<br>Code</th>
											<th style="background-color:#909090;color:#fff;border-color:white;width:80px;text-align:center;">Grup<br>Code</th>
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">Grup<br>Name</th>	
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">Parameter<br>Value</th>	
					  ...
					  "mRender": function(data, type, full) {
						...
						var outletCode = full.outletCode;
  						/*   var link = "<a href='<?="http://".$_SERVER['SERVER_NAME']."/index.php?view="?>"+via+"<?="&pid="?>"+full.outletCode+"<?="&uid="?>"+full.outletCode+"' title='Outlet Code: "+full.outletCode+"' target='_parent'>"
							...
							var link = "<a href='<?="http://".$_SERVER['SERVER_NAME']."/index.php?view="?>"+via+"<?="&kdParameter="?>"+full.kdParameter+"' title='Outlet Code: "+full.outletCode+"' target='_parent'>"
								+"<img src='img/editx.png' alt='' height='30' width='50'></img></a>";
