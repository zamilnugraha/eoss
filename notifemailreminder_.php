				...
				if(($monthY==01)&&($yearX==2019))
				{
					...
					***/
					$updateData = mysql_query("UPDATE ITH_TICKET_HEADER SET notifemailloop = '".$notifmailloop_x."',
												...
												ticket_udeptid = '8' AND ticketstatus_id = '1' 
				...
				}elseif(($monthY==12)&&($yearX==2019))
				{
					...
					***/
					...
					$insDataLog = mysql_query("INSERT INTO ITH_NOTIFEMAILLOOPX 
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].FIRST-REMINDER-TO-$storeName";	
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$updateData = mysql_query("UPDATE ITH_TICKET_HEADER SET notifemailloop = '".$notifmailloop_x."',
												   ...
												   AND ticket_udeptid = '8' AND ticketstatus_id = '1' 
												   AND ticket_createby = '".$rCekStoreKode->ticket_createby."'");	
						...
						$insDataLog = mysql_query("UPDATE ITH_NOTIFEMAILLOOP SET notifemailnumber = '".$notifmailloop_x."',
												   ...
												   WHERE ticket_id = '".$rCekStoreKode->ticket_id."' AND
												   ticket_udeptid = '8' AND ticketstatus_id = '1' AND ticket_handleby = '".$rCekStoreKode->ticket_createby."'");		
			...
			}elseif($rCekStoreKode->notifemailloop=='2')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].SECOND-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='3')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].THIRD-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='4')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].FOURTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='5')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].FIFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='6')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].SIXTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='7')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].SEVENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='8')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].EIGHTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='9')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].NINTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='10')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='11')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].ELEVENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='12')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWELFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='13')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].THIRTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='14')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].FOURTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='15')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].FIFTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='16')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].SIXTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='17')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].SEVENTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='18')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].EIGHTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='19')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].NINTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='20')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTIETH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='21')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTY-FIRST-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='22')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTY-SECOND-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='23')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTY-THIRD-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='24')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTY-FOURTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='25')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER FROM VENDOR].TWENTY-FIFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
