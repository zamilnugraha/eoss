  <link type="image/ico" href="images/transicon.ico" rel="shortcut icon"/>
<?php
...
header('Content-Disposition: inline; filename="chart.'.$imgtype.'"');
...
echo "<table height='100%' width='100%' border='0' cellspacing='1' style='vertical-align:top'>";
