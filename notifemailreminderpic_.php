<?
	...
	$qCekStoreKode = mysql_query("SELECT DISTINCT ITH_LOGREPORT.ticket_id, ITH_LOGREPORT.ticketrespond_by, USRPIC.userlevel_id, USRPIC.user_nik, ITH_LOGREPORT.ticketstatus_report,
									ITH_LOGREPORT.ticketreport_subject,
									...
									WHERE STR_TO_DATE(ITH_TICKET_HEADER.ticket_createdate,'%d/%m/%Y') BETWEEN STR_TO_DATE('01/01/2019','%d/%m/%Y') 
									AND STR_TO_DATE('".$dateNowX."','%d/%m/%Y') 
									AND	ITH_TICKET_HEADER.ticketstatus_id = '2' AND ITH_TICKET_HEADER.ticket_udeptid = '1' AND
									USRPIC.userlevel_id = '21' AND ITH_LOGREPORT.ticketstatus_report IN('4','2') 
									AND ITH_LOGREPORT.ticketreport_subject LIKE 'Menunggu direspon oleh PIC untuk tiket%'
				...
				if(($monthY==01)&&($yearX==2019))
				{
					...
					***/
					$updateData = mysql_query("UPDATE ITH_TICKET_HEADER SET notifemailloop = '".$notifmailloop_x."',
												...
												ticket_udeptid = '1' AND ticketstatus_id = '2' 
												AND ticket_createby = '".$rCekStoreKode->ticket_createby."'");		
					$insDataLog = mysql_query("INSERT INTO ITH_NOTIFEMAILLOOPX
				...
				}elseif(($monthY==12)&&($yearX==2019))
				{
					...
					***/
					...
					$insDataLog = mysql_query("INSERT INTO ITH_NOTIFEMAILLOOPX 
						...
						$mail->Subject    = "[MAIL REMINDER PIC].FIRST-REMINDER-TO-$storeName";	
						...
						<ul>
							...
							<li><b>Apabila pekerjaan belum selesai, segera hubungi vendor di  no telepon :</b></li>
						</ul><br>
		...
		{		
			...
			if($rCekStoreKode->notifemailloop=='1')
			{
				$qCekNotifMailX = mysql_query("SELECT ticket_id, ticketstatus_id, ticket_createdate, 
											   ...
											   FROM ITH_NOTIFEMAILLOOP WHERE ticket_id='".$rCekStoreKode->ticket_id."'");
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$updateData = mysql_query("UPDATE ITH_TICKET_HEADER SET notifemailloop = '".$notifmailloop_x."',
												   ...
												   AND ticket_udeptid = '1' AND ticketstatus_id = '2' 
												   AND ticket_createby = '".$rCekStoreKode->ticket_createby."'");	
						...
						$insDataLog = mysql_query("UPDATE ITH_NOTIFEMAILLOOP SET notifemailnumber = '".$notifmailloop_x."',
												   ...
												   WHERE ticket_id = '".$rCekStoreKode->ticket_id."' AND
												   ticket_udeptid = '1' AND ticketstatus_id = '2' AND ticket_handleby = '".$rCekStoreKode->ticket_createby."'");		
			...
			}elseif($rCekStoreKode->notifemailloop=='2')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].SECOND-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='3')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].THIRD-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='4')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].FOURTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='5')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].FIFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='6')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].SIXTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='7')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].SEVENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='8')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].EIGHTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='9')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].NINTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='10')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='11')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].ELEVENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='12')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWELFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='13')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].THIRTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='14')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].FOURTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='15')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].FIFTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='16')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].SIXTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='17')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].SEVENTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='18')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].EIGHTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='19')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].NINTEENTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='20')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTIETH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='21')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTY-FIRST-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='22')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTY-SECOND-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='23')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTY-THIRD-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='24')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTY-FOURTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
			...
			}elseif($rCekStoreKode->notifemailloop=='25')
			{
				...
				{	
					if($rCekNotifMailX->notifemailnextdate==$dateNow)
					{
						...
						$mail->Subject    = "[MAIL REMINDER PIC].TWENTY-FIFTH-REMINDER-TO-$storeName";	
						$mail->AltBody    = "$rCekStoreKode->ticket_subject"; 
