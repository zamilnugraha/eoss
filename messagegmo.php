...
<? if(($userlevel == 1000)||($userlevel == 1001)||($userlevel == 1002)||($userlevel == 3)||($userlevel == 4)||($userlevel == 8)){ /* Approval */?>
<div id="content" style="height:560px;margin-top:100px;">
	...
	?>
	  <? if(($rCekStatusApproval->ticketapprovalstatusid_gmo=='0')&&($rCekStatusApproval->ticketapprovalstatusid_am=='1')){ ?>	
	  <h3>ALREADY REQUEST APPROVED</h3>
	  <? }elseif($rCekStatusApproval->ticketapprovalstatusid_gmo=='0'){ ?>	
	  <h3>Rejection Page</h3>
 	  <? }elseif($rCekStatusApproval->ticketapprovalstatusid_gmo=='1'){ ?>	
	  <h3>Approval Page</h3>
	  <? } ?>
    </div>
