	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:25px;">
		<div class="row">
				...
				<?}elseif($userlevel=='3'){ /* AREA */ ?>						
						...
						<tr>
									<td><label style="width:70px;font-weight:bold;color:#000;">STORE :</label></td>
									<td>
										<select class="input-small" id="storefrom_sc" name="storefrom_sc" style="width:220px;">
											<option value="">-- ALL --</option>
										<?
								...
								<td><label style="width:80px; margin-left:-20px;font-weight:bold;color:#000;">Status :</label></td>
								<td>
							...
							<td><label style="width:80px; margin-left:0px;color:#000;font-weight:bold;">Request&nbsp;For&nbsp;:</label></td>
				...
				?>					
				<tr>
					<td><label style="width:30px;font-weight:bold;">Date&nbsp;From:</label></td>
					...
					<td><label style="width:30px;font-weight:bold;">Date&nbsp;To:</label></td>							
					<td><p id="dtto_sc" name="dtto_sc" style="font-size:10pt;">
							&nbsp;&nbsp; &nbsp;<input type="text" id="dtto_sc" name="dtto_sc" class="date end" style="margin-left:15px;width:60%;" value="<?=$datenow?>"/>
							</p></td>
					  ...
					  <link rel="stylesheet" type="text/css" href="js/lib/site.css" />
						...
						<?if($userlevel!='3'){?>
							...
							<td><label style="width:80px; margin-left:0px;">Requested For :</label></td>
							<td><select class="input-small" id="supportby_sc" name="supportby_sc" style="width:120px;">
										<option value="6">-- ALL --</option>
										<option value="1">ITD</option>
										<!--<option value="7">FSD ALL</option>-->
			...
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					...
					<center >
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                    <thead>
                                        <tr>
                                            <th style="background-color:#cc3333	;font-weight:bold;color:#fff;border-color:white;width:5px;text-align:center;">DATE</th>
											...
											<!--<th style="background-color:#909090;font-weight:bold;color:#fff;border-color:white;width:10px;text-align:center;">Aprv</th>-->
											<th style="background-color:#cc3333	;font-weight:bold;color:#fff;border-color:white;width:20px;text-align:center;">REQ.FOR</th>
											<!--<th style="background-color:#909090;font-weight:bold;color:#fff;border-color:white;width:20px">Gambar</th>-->
											<th style="background-color:#cc3333	;font-weight:bold;color:#fff;border-color:white;width:20px;text-align:center;">DETAIL</th>										
											<th style="background-color:#cc3333	;font-weight:bold;color:#fff;border-color:white;width:15;text-align:center;">APRVL</th>										
											<th style="background-color:#cc3333	;font-weight:bold;color:#fff;border-color:white;width:20px;text-align:center;">PIC</th>											
                                        </tr>
                                    </thead>
					...
					{"data": "",
					  ...
					  "mRender": function(data, type, full) {
						...
						/* APPROVAL BY GM OPR */  
							...
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS, DAN ROM TIKET TIDAK DIAPPROVAL) */
							if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && ((full.AprvlStsId3== 2 && full.AprvlStsId2== 0))){							  
								 link ="GMO1<center>test1<a href='#' title='Ticket ID:&nbsp;" +full.ticketId+ "' style='pointer-event:none;cursor:not-allowed;'>"
									+"<img src='img/unapproved.png' alt='' height='30' width='50' style='opacity:0.3;' title='UnApproval By : "+full.Apps1+"'></img></a></center>";
									
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH REGIONAL OPR MGR(ROM) DAN AKAN MENUNGGU APPROVAL DARI GM OPR) */
							}else if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && ((full.AprvlStsId3== 2 && full.AprvlStsId2== 1))){							  
								 link ="GMO2<center>test2<a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/goapps2.png' alt='' height='30' width='50' title='Aprvl : "+uname+"'></img></a></center>";
							
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH REGIONAL OPR MGR(ROM) DAN TIKET JUGA SUDAH DI APPROVAL OLEH GM OPR) */
							}else if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && ((full.AprvlStsId3== 1 && full.AprvlStsId2== 1))){						  
								 link ="GMO3<center>test3<a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/approveds.png' alt='' height='30' width='50' title='Aprvl : "+uname+"'></img></a></center>";
									
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH REGIONAL OPR MGR(ROM) TETAPI TIKET TIDAK DI APPROVAL OLEH GM OPR) */
							}else if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && ((full.AprvlStsId3== 0 && full.AprvlStsId2== 1))){						  
								 link ="GMO4<center>test4<a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
						...
						/* APPROVAL BY ROM */  
							...
							}else if((login==8) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && ((full.AprvlStsId2== 2 && full.AprvlStsId== 0))){							  
								 link ="ROM1<center><a href='#' title='Ticket ID:&nbsp;" +full.ticketId+ "' style='pointer-event:none;cursor:not-allowed;'>"
									+"<img src='img/unapproved.png' alt='' height='30' width='50' style='opacity:0.3;' title='UnApproval By : "+full.Apps1+"'></img></a></center>";
									
							/* ROM MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH AREA MGR DAN AKAN MENUNGGU APPROVAL DARI ROM(REGIONAL OPR MGR)) */
								 ...
								 link ="ROM2<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/goapps2.png' alt='' height='30' width='50' title='Aprvl : "+uname+"'></img></a></center>";
							
							/* ROM MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH AREA MGR(AM) DAN TIKET JUGA SUDAH DI APPROVAL OLEH ROM) */
								 ...
								 link ="ROM3<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/approveds.png' alt='' height='30' width='50' title='Aprvl : "+uname+"'></img></a></center>";
									
							/* ROM MENJADI APPROVAL (STATUS TICKET ON PROCESS, TIKET SUDAH DI APPROVAL OLEH AREA MGR(AM) TETAPI TIKET TIDAK DI APPROVAL OLEH REGIONAL OPR MGR (ROM)) */
								 ...
								 link ="ROM4<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/unapproved.png' alt='' height='30' width='50' title='Aprvl : "+uname+"'></img></a></center>";
						...
						/* APPROVAL AREA MANAGER /
							...
							/* AREA MGR MENJADI APPROVAL (STATUS TICKET ON PROCESS AND STATUS DI APPROVAL OLEH AREA MGR) */
								 ...
								 link ="AM-2<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
							...
							/* AREA MGR MENJADI APPROVAL (STATUS TICKET ON PROCESS AND STATUS TIDAK DI APPROVAL OLEH AREA MGR) */
								 ...
								 link ="AM-3<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
							...
							/* AREA MGR MENJADI PIC */
							  ...
							  link ="AM-4<a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view="?>"+via+"<?="&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID: "+full.ticketId+"' target='_parent'>"
