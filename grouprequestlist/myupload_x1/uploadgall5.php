...
$gallery_name5 = $_FILES["myfile"]["name"];
$gallery_size5 = $_FILES["myfile"]["size"];
$gallery_location5 = '/dc9144e0ece8bcd25dd3a4dcb7b305a3/picture/gallery/data_'.$id_talentdetail.'/';
...
if(isset($_FILES["myfile"])){
    ...
    if(move_uploaded_file($_FILES["myfile"]["tmp_name"],$output_dir. $gallery_name5))
	{		
		mysql_query("UPDATE talent_detail SET gallery_name5='$gallery_name5', gallery_location5='$gallery_location5', gallery_size5='$gallery_size5' WHERE id_talentdetail='$id_talentdetail' ");
    }else{
		echo "Gagal Uplaod";
	}
