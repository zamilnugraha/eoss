	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:25px;">
		<div class="row">
				...
				<?}elseif($userlevel=='3'){ /* AREA */ ?>						
						...
						<tr>
									<td><label style="width:70px;font-weight:bold;">STORE :</label></td>
									<td>
										<select class="input-small" id="storefrom_sc" name="storefrom_sc" style="width:220px;">
											<option value="">-- ALL --</option>
										<?
								...
								<td><label style="width:80px; margin-left:-20px;font-weight:bold;">Status :</label></td>
								<td>
				...
				<tr>
					...
					<td style="width:30px;margin-left:0px;font-weight:bold;"><label>Date&nbsp;To:</label></td>
			...
			<div style="margin-left:15px;margin-top:-50px;font-family:Arial,Helvetica,sans-serif;font-size: 13px;">
					<font size="4">&nbsp;Daftar PeLaporan (Group)</font>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example" >
                                    <thead>
                                        <tr>
											...
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px;text-align:center;">Via</th>
											...
											<th style="background-color:#909090;color:#fff;border-color:white;width:15">Aprvl</th>										
											<th style="background-color:#909090;color:#fff;border-color:white;width:20px">PIC</th>											
                                        </tr>
                                    </thead>
