	...
	<div class="container" style="margin-left:5px;width:95%;height:auto;margin-top:25px;">
		<div class="row">
				...
				<?if(($userlevel=='4')||($userlevel=='8')){ /* ROM */ ?>
						<tr>
									<td><label style="width:70px;color:#000000;font-weight:bold;">ROM :</label></td>
									<td>
						...
						<tr>
									<td><label style="width:70px;color:#000000;font-weight:bold;">AREA :</label></td>
									<td>
									...
									<td><label style="width:50px;color:#000000;font-weight:bold;">To :</label></td>
									<td>
						...
						<tr>
									<td><label style="width:70px;color:#000000;font-weight:bold;">STORE :</label></td>
									<td>
				...
				<?}elseif($userlevel=='3'){ /* AREA */ ?>						
						...
						<tr>
							...
							<td><label style="width:80px; margin-left:0px;color:#000;font-weight:bold;">Request<br>For :</label></td>
				...
				?>					
				<tr>
					<td><label style="width:30px;color:#000000;font-weight:bold;">Date&nbsp;From:</label></td>
					...
					<td><label style="width:30px;color:#000000;font-weight:bold;">Date&nbsp;To:</label></td>							
					<td><p id="dtto_sc" name="dtto_sc" style="font-size:10pt;">
					  ...
					  <link rel="stylesheet" type="text/css" href="js/lib/site.css" />
						...
						<?if($userlevel!='3'){?>
							<td><label style="width:80px;color:#000000;font-weight:bold;margin-left:0px;">Status :</label></td>
							<td>
							...
							<td><label style="width:80px;color:#000000;font-weight:bold;margin-left:0px;">Requested For :</label></td>
							<td><select class="input-small" id="supportby_sc" name="supportby_sc" style="width:120px;">
										<option value="6">-- ALL --</option>
										<option value="1">ITD</option>
										<!--<option value="7">FSD ALL</option>-->
                                    ...
                                    <thead>
										...
										<!--<th style="background-color:#cc3333;font-weight:bold;color:#fff;border-color:white;width:5px;text-align:center;">TIME</th>-->
											...
											<? if($_SESSION['user_level']==3){ ?>
												<th style="background-color:#cc3333;font-weight:bold;color:#fff;border-color:white;width:20px;text-align:center;display:none;">PIC</th>											
											<? }elseif(($_SESSION['user_level']==8)||($_SESSION['user_level']==1000)){ ?>
												<th style="background-color:#cc3333;display:none;font-weight:bold;color:#fff;border-color:white;width:20px;text-align:center;">PIC</th>											
											<? } ?>
									   </tr>
                                    </thead>
					...
					{"data": "",
					  ...
					  "mRender": function(data, type, full) {
						...
						/* APPROVAL BY GM OPR */  
							...
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS, DAN ROM TIKET TIDAK DIAPPROVAL) AprvlStsId3 */
							if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && (full.AprvlStsId3== 2)){							  
							...
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS AND STATUS DI APPROVAL OLEH AREA MGR) */
							}else if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && (full.AprvlStsId3== 1)){							  
								 link ="<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
									+"<img src='img/approveds.png' alt='' height='30' width='50' title='Aprvl By : "+uname+"'></img></a></center>";
									
							/* GM OPR MENJADI APPROVAL (STATUS TICKET ON PROCESS AND STATUS TIDAK DI APPROVAL OLEH AREA MGR) */
							}else if((login==1000) && (full.Apps1 == uname || full.Apps2 == uname || full.Apps3 == uname || full.Apps4 == uname || full.Apps5 == uname) && (full.status=='On Process') && (full.AprvlStsId3== 0)){							  
								 link ="<center><a href='<?="http://".$_SERVER['SERVER_NAME']."/eoss/index.php?view=home&pid="?>"+full.ticketId+"<?="&uid=".$_SESSION['user_id']?>' title='Ticket ID:&nbsp;" +full.ticketId+ "' target='_parent'>"
