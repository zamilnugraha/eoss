...
?>
	...
	{ ?>
		...
		<? }elseif(($detailmyticketKeteranganData->keterangan=='MOVE TO WAREHOUSE')){ ?>
			...
			<font color="#ffffff"><b><u>ASSIGNMENT OF TECHNICAL PERSONS BY THE FSD MANAGER </u></b></font>
		...
		<? if($rvCekDataHeaderEQx->REQUEST_BY == $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=fsdct&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST">
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_TIPEBARANG_KODE.ticket_needassist IN('YES') AND
						...
						<? /* if($rCekDataInputan->transfer_date==''){ */ if($rCekDataInputan->pictakein_date==''){ ?>	
		...
		<? }elseif($rvCekDataHeaderEQx->REQUEST_BY != $_GET['uid']){ ?>
			...
			<style>
				...
				<!--<input id="equipmentsrc" type="text" placeholder="Search..">-->
				<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;"> 
					<form name="myForm" id="myForm" target="_myFrame" action="index.php?m=form&a=fsdct&pid=<?=$_GET['pid']?>&uid=<?=$_GET['uid']?>" method="POST" height="auto">
					<table class="blueTable" border="1"> 
						<thead>
							<tr>
								<?  
					...
					<div style="width:100%; height:auto; overflow:auto;position:relative;color:#000000;">
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? 
																	$qCekDataInputan = mysql_query("SELECT ticket_id,kode_tipebrg,kode_tipebarang,pic_createddate, pic_createdby, pic_name,pictakein_date,pictakein_by,
																									ITH_TIPEBARANG_KODE.transfer_by, ITH_TIPEBARANG_KODE.transfer_date, ITH_TIPEBARANG_KODE.kode_tipebarang,
																									...
																									ITH_TIPEBARANG_KODE.pic_createddate,
																	...
																	$transferbyName = preg_replace('/[^A-Za-z0-9\  ]/', '', $rCekDataInputan->pic_name);
																...
																<? if(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->pic_name=='')){ ?>
																		<? 
																			$mydate = date('d/m/Y', strtotime('today - 30 days'));
																			#$mydate = date('d/m/Y');
																			/*$mydate = date('d/m/Y', strtotime('today + 30 days'));*/
																		...
																		?>
																			...
																			<input type="hidden" name="kdtipebrg[]" id="<?='kdtipebrg'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" value="<?=$rvCekDataEQx["KODE_TIPEBARANG"]?>"></input>
																			<font color="#000"><b>Assignment&nbsp;By :</b></font>
																			<?
																			...
																			<font color="#000"><b>Transferred&nbsp;Date :</b></font>
																			<p name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					&nbsp;&nbsp; &nbsp;<input type="text" name="dttransfer_sc[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_sc'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" class="date start" style="margin-left:15px;width:60%;" value=""/><!--?=$datenow?-->   							
																			</p>
																			...
																			<p name="dttransfer_by[<?=$rvCekDataEQx["KODE_TIPEBARANG"];?>]" id="<?='dttransfer_by'.$rvCekDataEQx["KODE_TIPEBARANG"];?>" style="font-size:10pt;margin-left:85px;margin-top:-17px;">
																					...
																					<option value="" style="pointer-event:none;cursor:not-allowed;">PLEASE CHOOSE</option>
																					<? 
																...
																<? }elseif(($rCekDataInputan->ticket_needassist=='YES')&&($rCekDataInputan->pic_name!='')){ ?>
																		&nbsp;&nbsp;<b>Assignment&nbsp;By&nbsp; :</b>&nbsp;&nbsp;<?=''.ucwords(strtolower('ANDI AGUNG KASIM')).' (FSD MGR)'?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;Date&nbsp;:</b>&nbsp;&nbsp;<?=$rCekDataInputan->pictakein_date?><br>
																		&nbsp;&nbsp;<b>Transferred&nbsp;By&nbsp;:</b>&nbsp;&nbsp;<?=''.ucwords(strtolower($rCekDataInputan->pic_name)).' (FSD TECHNICIAN)'?>	
																	<? } ?>			
						...
						<? /* if($rCekDataInputan->received_date==''){ */ if($rCekDataInputan->pictakein_date==''){ ?>	
						<input type="submit" value="Submit" style="margin-left:1020px;" />	
						<? } ?>
					</form>	
					</div>	
