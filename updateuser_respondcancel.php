...
?>
<? if(($rCekTipeKodeBarang->tickettransferto_outletcode!=$_SESSION['user_nik'])||($rCekTipeKodeBarang->tickettransferto_outletcode!=$_SESSION['user_nik'])){ ?>
		UNDERCONSTRUCTION !!! <br><? include("reqstore_admin_receive.php");?>
<? }elseif(($rCekTipeKodeBarang->tickettransferto_outletcode==$_SESSION['user_nik'])||($rCekTipeKodeBarang->tickettransferto_outletcode==$_SESSION['user_nik'])){ ?>
