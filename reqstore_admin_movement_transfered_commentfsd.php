												...
												{	
															...
															**/
															$qvCekDataEQx = mysql_query("SELECT DISTINCT ITH_TIPEBARANG_KODE.TICKET_ID, ITH_TIPEBARANG_KODE.NO_PERMINTAAN,
																						...
																						ITH_TIPEBARANG_KODE.ticket_needassist = 'YES' 
																						AND(ITH_TIPEBARANG_KODE.ticketapprovalstatusid_am ='1' 
																						AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_rom ='1' 
																						AND ITH_TIPEBARANG_KODE.ticketapprovalstatusid_gmo ='1')");
															###$rvCekDataEQ = mysql_fetch_object($qvCekDataEQ);												
														...
														{    #echo "<br>SOLVED";			
															...
															<tr>												
																...
																*/	$qvSCatReplace2 = "SELECT DISTINCT 
																...
																<? 
																	$qCekDataInputan = mysql_query("SELECT DISTINCT transfer_by, transfer_date, tickettransferto_outletcode, tickettransferto_outletname 
																									FROM ITH_TIPEBARANG_KODE 
																									WHERE ticket_id ='".$_GET['pid']."' 
