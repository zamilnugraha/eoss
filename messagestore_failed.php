...
<div id="content" style="height:560px;margin-top:100px;">
    ...
    <div class="body" style="height:500px;">
		...
		<!--	<button onclick="location.href = '?m=form&a=npfsd&pid=<!?=$_GET['pid'];?>&uid=<!?=$_SESSION['user_nik'];?>';" id="myButton" class="submit-btn">RESEND</button>&nbsp;-->
			<button onclick="location.href = '?view=mailresendstore&pid=<?=$_GET['pid'];?>&uid=<?=$_SESSION['user_nik'];?>';" id="myButton" class="submit-btn">RESEND</button>&nbsp;
		</div>
